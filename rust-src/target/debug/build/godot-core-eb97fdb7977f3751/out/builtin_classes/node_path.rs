...
impl < 'a > InnerNodePath < 'a > {
    ...
    pub fn is_absolute(&self,) -> bool {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "NodePath", "is_absolute", self.sys_ptr, args)
        }
    }
    ...
    pub fn get_concatenated_names(&self,) -> StringName {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "NodePath", "get_concatenated_names", self.sys_ptr, args)
        }
    }
    pub fn get_concatenated_subnames(&self,) -> StringName {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "NodePath", "get_concatenated_subnames", self.sys_ptr, args)
        }
    }
    ...
    pub fn get_as_property_path(&self,) -> NodePath {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "NodePath", "get_as_property_path", self.sys_ptr, args)
        }
    }
    pub fn is_empty(&self,) -> bool {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "NodePath", "is_empty", self.sys_ptr, args)
        }
    }
}