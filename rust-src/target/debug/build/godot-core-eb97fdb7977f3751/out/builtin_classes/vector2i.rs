...
impl < 'a > InnerVector2i < 'a > {
    ...
    pub fn distance_to(&self, to: Vector2i,) -> f64 {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "distance_to", self.sys_ptr, args)
        }
    }
    pub fn distance_squared_to(&self, to: Vector2i,) -> i64 {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "distance_squared_to", self.sys_ptr, args)
        }
    }
    ...
    pub fn clampi(&self, min: i64, max: i64,) -> Vector2i {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "clampi", self.sys_ptr, args)
        }
    }
    ...
    pub fn snappedi(&self, step: i64,) -> Vector2i {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "snappedi", self.sys_ptr, args)
        }
    }
    ...
    pub fn mini(&self, with: i64,) -> Vector2i {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "mini", self.sys_ptr, args)
        }
    }
    ...
    pub fn maxi(&self, with: i64,) -> Vector2i {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "Vector2i", "maxi", self.sys_ptr, args)
        }
    }
}
#[repr(transparent)]
