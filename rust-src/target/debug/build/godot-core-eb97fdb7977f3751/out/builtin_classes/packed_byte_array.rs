...
impl < 'a > InnerPackedByteArray < 'a > {
    ...
    pub fn get_string_from_ascii(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "get_string_from_ascii", self.sys_ptr, args)
        }
    }
    pub fn get_string_from_utf8(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "get_string_from_utf8", self.sys_ptr, args)
        }
    }
    pub fn get_string_from_utf16(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "get_string_from_utf16", self.sys_ptr, args)
        }
    }
    pub fn get_string_from_utf32(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "get_string_from_utf32", self.sys_ptr, args)
        }
    }
    pub fn get_string_from_wchar(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "get_string_from_wchar", self.sys_ptr, args)
        }
    }
    pub fn hex_encode(&self,) -> GString {
        ...
        unsafe {
            ...
            < CallSig as PtrcallSignatureTuple > ::out_builtin_ptrcall(method_bind, "PackedByteArray", "hex_encode", self.sys_ptr, args)
        }
    }
