...
pub(super) mod re_export {
    ...
    impl Texture2D {
        pub fn get_width(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "get_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_height(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "get_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_alpha(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "has_alpha", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn draw_full(&self, canvas_item: Rid, position: Vector2, modulate: Color, transpose: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "draw", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn draw_rect_full(&self, canvas_item: Rid, rect: Rect2, tile: bool, modulate: Color, transpose: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "draw_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn draw_rect_region_full(&self, canvas_item: Rid, rect: Rect2, src_rect: Rect2, modulate: Color, transpose: bool, clip_uv: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "draw_rect_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_image(&self,) -> Option < Gd < crate::classes::Image > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "get_image", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_placeholder(&self,) -> Option < Gd < crate::classes::Resource > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Texture2D", "create_placeholder", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Texture2D {
        ($Class: ident) => {
