...
pub(super) mod re_export {
    ...
    impl EditorInspectorPlugin {
        pub fn add_custom_control(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_custom_control", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_property_editor_full(&mut self, property: CowArg < GString >, editor: ObjectArg < crate::classes::Control >, add_to_end: bool, label: CowArg < GString >,) {
            type CallSig < 'a0, 'a1, > = ((), CowArg < 'a0, GString >, ObjectArg < crate::classes::Control >, bool, CowArg < 'a1, GString >);
            let args = (property, editor, add_to_end, label,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(98usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_property_editor", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn add_property_editor_for_multiple_properties(&mut self, label: impl AsArg < GString >, properties: &PackedStringArray, editor: impl AsObjectArg < crate::classes::Control >,) {
            type CallSig < 'a0, 'a1, > = ((), CowArg < 'a0, GString >, RefArg < 'a1, PackedStringArray >, ObjectArg < crate::classes::Control >);
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_property_editor_for_multiple_properties", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorInspectorPlugin {
        ($Class: ident) => {
