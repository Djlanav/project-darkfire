...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`Separator`][crate::classes::Separator].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `Separator` methods](https://docs.godotengine.org/en/stable/classes/class_separator.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ISeparator: crate::obj::GodotClass < Base = Separator > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`Separator`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_Separator {
        ($Class: ident) => {
