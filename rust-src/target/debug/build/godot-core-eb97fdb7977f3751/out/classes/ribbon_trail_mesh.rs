...
pub(super) mod re_export {
    ...
    impl RibbonTrailMesh {
        pub fn set_size(&mut self, size: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sections(&mut self, sections: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sections(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_length(&mut self, section_length: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_segments(&mut self, section_segments: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_section_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_segments(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_section_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_curve(&mut self, curve: impl AsObjectArg < crate::classes::Curve >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_curve(&self,) -> Option < Gd < crate::classes::Curve > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shape(&mut self, shape: crate::classes::ribbon_trail_mesh::Shape,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "set_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shape(&self,) -> crate::classes::ribbon_trail_mesh::Shape {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RibbonTrailMesh", "get_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RibbonTrailMesh {
        ($Class: ident) => {
