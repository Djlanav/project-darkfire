...
pub(super) mod re_export {
    ...
    impl PhysicalBone2D {
        pub fn get_joint(&self,) -> Option < Gd < crate::classes::Joint2D > > {
            type CallSig = (Option < Gd < crate::classes::Joint2D > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6062usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_joint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_auto_configure_joint(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_auto_configure_joint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_auto_configure_joint(&mut self, auto_configure_joint: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "set_auto_configure_joint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_simulate_physics(&mut self, simulate_physics: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "set_simulate_physics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_simulate_physics(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_simulate_physics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_simulating_physics(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "is_simulating_physics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bone2d_nodepath(&mut self, nodepath: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "set_bone2d_nodepath", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bone2d_nodepath(&self,) -> NodePath {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_bone2d_nodepath", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bone2d_index(&mut self, bone_index: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "set_bone2d_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bone2d_index(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_bone2d_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_follow_bone_when_simulating(&mut self, follow_bone: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "set_follow_bone_when_simulating", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_follow_bone_when_simulating(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicalBone2D", "get_follow_bone_when_simulating", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PhysicalBone2D {
        ($Class: ident) => {
