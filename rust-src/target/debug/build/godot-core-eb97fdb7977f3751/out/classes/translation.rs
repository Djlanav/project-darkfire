...
pub(super) mod re_export {
    ...
    impl Translation {
        pub fn set_locale(&mut self, locale: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "set_locale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_locale(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_locale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_message_full(&mut self, src_message: CowArg < StringName >, xlated_message: CowArg < StringName >, context: CowArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "add_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn add_plural_message_full(&mut self, src_message: CowArg < StringName >, xlated_messages: RefArg < PackedStringArray >, context: CowArg < StringName >,) {
            type CallSig < 'a0, 'a1, 'a2, > = ((), CowArg < 'a0, StringName >, RefArg < 'a1, PackedStringArray >, CowArg < 'a2, StringName >);
            let args = (src_message, xlated_messages, context,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9453usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "add_plural_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_message_full(&self, src_message: CowArg < StringName >, context: CowArg < StringName >,) -> StringName {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_plural_message_full(&self, src_message: CowArg < StringName >, src_plural_message: CowArg < StringName >, n: i32, context: CowArg < StringName >,) -> StringName {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_plural_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn erase_message_full(&mut self, src_message: CowArg < StringName >, context: CowArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "erase_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_message_list(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_message_list", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_translated_message_list(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_translated_message_list", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_message_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Translation", "get_message_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Translation {
        ($Class: ident) => {
