...
pub(super) mod re_export {
    ...
    impl RemoteTransform3D {
        pub fn set_remote_node(&mut self, path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "set_remote_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_remote_node(&self,) -> NodePath {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "get_remote_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn force_update_cache(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "force_update_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_global_coordinates(&mut self, use_global_coordinates: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "set_use_global_coordinates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_use_global_coordinates(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "get_use_global_coordinates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_position(&mut self, update_remote_position: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "set_update_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_position(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "get_update_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_rotation(&mut self, update_remote_rotation: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "set_update_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_rotation(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "get_update_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_scale(&mut self, update_remote_scale: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "set_update_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_scale(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RemoteTransform3D", "get_update_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RemoteTransform3D {
        ($Class: ident) => {
