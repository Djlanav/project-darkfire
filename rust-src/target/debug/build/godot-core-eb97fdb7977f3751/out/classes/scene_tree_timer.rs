...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`SceneTreeTimer`][crate::classes::SceneTreeTimer].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `SceneTreeTimer` methods](https://docs.godotengine.org/en/stable/classes/class_scenetreetimer.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ISceneTreeTimer: crate::obj::GodotClass < Base = SceneTreeTimer > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SceneTreeTimer {
        pub fn set_time_left(&mut self, time: f64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneTreeTimer", "set_time_left", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_time_left(&self,) -> f64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneTreeTimer", "get_time_left", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`SceneTreeTimer`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_SceneTreeTimer {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::SceneTreeTimer > for $Class {
