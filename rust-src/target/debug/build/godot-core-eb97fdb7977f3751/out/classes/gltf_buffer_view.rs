...
pub(super) mod re_export {
    ...
    impl GltfBufferView {
        pub fn load_buffer_view_data(&self, state: impl AsObjectArg < crate::classes::GltfState >,) -> PackedByteArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "load_buffer_view_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffer(&mut self, buffer: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_offset(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_offset(&mut self, byte_offset: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_length(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_length(&mut self, byte_length: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_stride(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_stride(&mut self, byte_stride: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_indices(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_indices(&mut self, indices: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_attributes(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_vertex_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_attributes(&mut self, is_attributes: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_vertex_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_GltfBufferView {
        ($Class: ident) => {
