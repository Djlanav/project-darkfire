...
pub(super) mod re_export {
    ...
    impl ConeTwistJoint3D {
        pub fn set_param(&mut self, param: crate::classes::cone_twist_joint_3d::Param, value: f32,) {
            type CallSig = ((), crate::classes::cone_twist_joint_3d::Param, f32);
            let args = (param, value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2267usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConeTwistJoint3D", "set_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_param(&self, param: crate::classes::cone_twist_joint_3d::Param,) -> f32 {
            type CallSig = (f32, crate::classes::cone_twist_joint_3d::Param);
            let args = (param,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2268usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConeTwistJoint3D", "get_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ConeTwistJoint3D {
        ($Class: ident) => {
