...
pub(super) mod re_export {
    ...
    impl OpenXrHand {
        pub fn set_hand(&mut self, hand: crate::classes::open_xr_hand::Hands,) {
            type CallSig = ((), crate::classes::open_xr_hand::Hands);
            let args = (hand,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5771usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "set_hand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_hand(&self,) -> crate::classes::open_xr_hand::Hands {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "get_hand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_motion_range(&mut self, motion_range: crate::classes::open_xr_hand::MotionRange,) {
            type CallSig = ((), crate::classes::open_xr_hand::MotionRange);
            let args = (motion_range,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5773usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "set_motion_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_motion_range(&self,) -> crate::classes::open_xr_hand::MotionRange {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "get_motion_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skeleton_rig(&mut self, skeleton_rig: crate::classes::open_xr_hand::SkeletonRig,) {
            type CallSig = ((), crate::classes::open_xr_hand::SkeletonRig);
            let args = (skeleton_rig,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5775usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "set_skeleton_rig", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skeleton_rig(&self,) -> crate::classes::open_xr_hand::SkeletonRig {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "get_skeleton_rig", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bone_update(&mut self, bone_update: crate::classes::open_xr_hand::BoneUpdate,) {
            type CallSig = ((), crate::classes::open_xr_hand::BoneUpdate);
            let args = (bone_update,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5777usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "set_bone_update", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bone_update(&self,) -> crate::classes::open_xr_hand::BoneUpdate {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrHand", "get_bone_update", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_OpenXrHand {
        ($Class: ident) => {
