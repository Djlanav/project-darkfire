...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`XrTracker`][crate::classes::XrTracker].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `XRTracker` methods](https://docs.godotengine.org/en/stable/classes/class_xrtracker.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IXrTracker: crate::obj::GodotClass < Base = XrTracker > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl XrTracker {
        pub fn get_tracker_type(&self,) -> crate::classes::xr_server::TrackerType {
            type CallSig = (crate::classes::xr_server::TrackerType,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10603usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "get_tracker_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tracker_type(&mut self, type_: crate::classes::xr_server::TrackerType,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "set_tracker_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tracker_name(&self,) -> StringName {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "get_tracker_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tracker_name(&mut self, name: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "set_tracker_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tracker_desc(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "get_tracker_desc", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tracker_desc(&mut self, description: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrTracker", "set_tracker_desc", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`XrTracker`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_XrTracker {
        ($Class: ident) => {
