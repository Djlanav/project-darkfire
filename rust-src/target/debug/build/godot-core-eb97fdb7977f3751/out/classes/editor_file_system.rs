...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`EditorFileSystem`][crate::classes::EditorFileSystem].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `EditorFileSystem` methods](https://docs.godotengine.org/en/stable/classes/class_editorfilesystem.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IEditorFileSystem: crate::obj::GodotClass < Base = EditorFileSystem > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl EditorFileSystem {
        pub fn get_filesystem(&mut self,) -> Option < Gd < crate::classes::EditorFileSystemDirectory > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "get_filesystem", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_scanning(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "is_scanning", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scanning_progress(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "get_scanning_progress", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn scan(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "scan", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn scan_sources(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "scan_sources", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_file(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "update_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_filesystem_path(&mut self, path: impl AsArg < GString >,) -> Option < Gd < crate::classes::EditorFileSystemDirectory > > {
            type CallSig < 'a0, > = (Option < Gd < crate::classes::EditorFileSystemDirectory > >, CowArg < 'a0, GString >);
            let args = (path.into_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(77usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "get_filesystem_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_file_type(&self, path: impl AsArg < GString >,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "get_file_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn reimport_files(&mut self, files: &PackedStringArray,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorFileSystem", "reimport_files", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`EditorFileSystem`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_EditorFileSystem {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::EditorFileSystem > for $Class {
