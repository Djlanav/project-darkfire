...
pub(super) mod re_export {
    ...
    impl BackBufferCopy {
        pub fn set_rect(&mut self, rect: Rect2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BackBufferCopy", "set_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rect(&self,) -> Rect2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BackBufferCopy", "get_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_copy_mode(&mut self, copy_mode: crate::classes::back_buffer_copy::CopyMode,) {
            type CallSig = ((), crate::classes::back_buffer_copy::CopyMode);
            let args = (copy_mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1022usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BackBufferCopy", "set_copy_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_copy_mode(&self,) -> crate::classes::back_buffer_copy::CopyMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BackBufferCopy", "get_copy_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_BackBufferCopy {
        ($Class: ident) => {
