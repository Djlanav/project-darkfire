...
pub(super) mod re_export {
    ...
    impl XrPositionalTracker {
        pub fn get_tracker_profile(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "get_tracker_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tracker_profile(&mut self, profile: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "set_tracker_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tracker_hand(&self,) -> crate::classes::xr_positional_tracker::TrackerHand {
            type CallSig = (crate::classes::xr_positional_tracker::TrackerHand,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10595usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "get_tracker_hand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tracker_hand(&mut self, hand: crate::classes::xr_positional_tracker::TrackerHand,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "set_tracker_hand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_pose(&self, name: impl AsArg < StringName >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "has_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pose(&self, name: impl AsArg < StringName >,) -> Option < Gd < crate::classes::XrPose > > {
            type CallSig < 'a0, > = (Option < Gd < crate::classes::XrPose > >, CowArg < 'a0, StringName >);
            let args = (name.into_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10598usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "get_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn invalidate_pose(&mut self, name: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "invalidate_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pose(&mut self, name: impl AsArg < StringName >, transform: Transform3D, linear_velocity: Vector3, angular_velocity: Vector3, tracking_confidence: crate::classes::xr_pose::TrackingConfidence,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, StringName >, Transform3D, Vector3, Vector3, crate::classes::xr_pose::TrackingConfidence);
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "set_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input(&self, name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "get_input", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_input(&mut self, name: impl AsArg < StringName >, value: &Variant,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrPositionalTracker", "set_input", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_XrPositionalTracker {
        ($Class: ident) => {
