...
pub(super) mod re_export {
    ...
    impl DirectionalLight3D {
        pub fn set_shadow_mode(&mut self, mode: crate::classes::directional_light_3d::ShadowMode,) {
            type CallSig = ((), crate::classes::directional_light_3d::ShadowMode);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2622usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "set_shadow_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shadow_mode(&self,) -> crate::classes::directional_light_3d::ShadowMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "get_shadow_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_blend_splits(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "set_blend_splits", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_blend_splits_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "is_blend_splits_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sky_mode(&mut self, mode: crate::classes::directional_light_3d::SkyMode,) {
            type CallSig = ((), crate::classes::directional_light_3d::SkyMode);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2626usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "set_sky_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sky_mode(&self,) -> crate::classes::directional_light_3d::SkyMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "DirectionalLight3D", "get_sky_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_DirectionalLight3D {
        ($Class: ident) => {
