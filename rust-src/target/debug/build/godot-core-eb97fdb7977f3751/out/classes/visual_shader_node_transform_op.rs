...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeTransformOp {
        pub fn set_operator(&mut self, op: crate::classes::visual_shader_node_transform_op::Operator,) {
            type CallSig = ((), crate::classes::visual_shader_node_transform_op::Operator);
            let args = (op,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10162usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTransformOp", "set_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_operator(&self,) -> crate::classes::visual_shader_node_transform_op::Operator {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTransformOp", "get_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeTransformOp {
        ($Class: ident) => {
