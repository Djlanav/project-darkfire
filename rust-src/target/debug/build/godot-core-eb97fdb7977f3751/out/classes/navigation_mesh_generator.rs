...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`NavigationMeshGenerator`][crate::classes::NavigationMeshGenerator].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `NavigationMeshGenerator` methods](https://docs.godotengine.org/en/stable/classes/class_navigationmeshgenerator.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait INavigationMeshGenerator: crate::obj::GodotClass < Base = NavigationMeshGenerator > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`NavigationMeshGenerator`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_NavigationMeshGenerator {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::NavigationMeshGenerator > for $Class {
