...
pub(super) mod re_export {
    ...
    impl PhysicsServer2DExtension {
        pub fn body_test_motion_is_excluding_body(&self, body: Rid,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicsServer2DExtension", "body_test_motion_is_excluding_body", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn body_test_motion_is_excluding_object(&self, object: u64,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicsServer2DExtension", "body_test_motion_is_excluding_object", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PhysicsServer2DExtension {
        ($Class: ident) => {
