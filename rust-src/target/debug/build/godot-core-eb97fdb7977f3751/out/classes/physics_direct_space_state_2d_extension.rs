...
pub(super) mod re_export {
    ...
    impl PhysicsDirectSpaceState2DExtension {
        pub fn is_body_excluded_from_query(&self, body: Rid,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicsDirectSpaceState2DExtension", "is_body_excluded_from_query", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PhysicsDirectSpaceState2DExtension {
        ($Class: ident) => {
