...
pub(super) mod re_export {
    ...
    impl XmlParser {
        pub fn read(&mut self,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "read", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_node_type(&mut self,) -> crate::classes::xml_parser::NodeType {
            type CallSig = (crate::classes::xml_parser::NodeType,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10492usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_node_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_node_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_node_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_node_data(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_node_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_node_offset(&self,) -> u64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_node_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attribute_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_attribute_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attribute_name(&self, idx: i32,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_attribute_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attribute_value(&self, idx: i32,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_attribute_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_attribute(&self, name: impl AsArg < GString >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "has_attribute", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_named_attribute_value(&self, name: impl AsArg < GString >,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_named_attribute_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_named_attribute_value_safe(&self, name: impl AsArg < GString >,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_named_attribute_value_safe", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_empty(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "is_empty", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_current_line(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "get_current_line", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn skip_section(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "skip_section", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn seek(&mut self, position: u64,) -> crate::global::Error {
            type CallSig = (crate::global::Error, u64);
            let args = (position,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10505usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "seek", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn open(&mut self, file: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "open", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn open_buffer(&mut self, buffer: &PackedByteArray,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XmlParser", "open_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_XmlParser {
        ($Class: ident) => {
