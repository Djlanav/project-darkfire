...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`PhysicsServer3DManager`][crate::classes::PhysicsServer3DManager].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `PhysicsServer3DManager` methods](https://docs.godotengine.org/en/stable/classes/class_physicsserver3dmanager.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IPhysicsServer3DManager: crate::obj::GodotClass < Base = PhysicsServer3DManager > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PhysicsServer3DManager {
        ...
        pub fn register_server(&mut self, name: impl AsArg < GString >, create_callback: &Callable,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicsServer3DManager", "register_server", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_default_server(&mut self, name: impl AsArg < GString >, priority: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PhysicsServer3DManager", "set_default_server", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`PhysicsServer3DManager`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_PhysicsServer3DManager {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::PhysicsServer3DManager > for $Class {
