...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`ResourceUid`][crate::classes::ResourceUid].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `ResourceUID` methods](https://docs.godotengine.org/en/stable/classes/class_resourceuid.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IResourceUid: crate::obj::GodotClass < Base = ResourceUid > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ResourceUid {
        ...
        pub fn id_to_text(&self, id: i64,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "id_to_text", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn text_to_id(&self, text_id: impl AsArg < GString >,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "text_to_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_id(&mut self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "create_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_id(&self, id: i64,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "has_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_id(&mut self, id: i64, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "add_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_id(&mut self, id: i64, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "set_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_id_path(&self, id: i64,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "get_id_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_id(&mut self, id: i64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceUid", "remove_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ResourceUid`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_ResourceUid {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::ResourceUid > for $Class {
