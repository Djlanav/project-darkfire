...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`PlaceholderTextureLayered`][crate::classes::PlaceholderTextureLayered].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `PlaceholderTextureLayered` methods](https://docs.godotengine.org/en/stable/classes/class_placeholdertexturelayered.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IPlaceholderTextureLayered: crate::obj::GodotClass < Base = PlaceholderTextureLayered > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl PlaceholderTextureLayered {
        pub fn set_size(&mut self, size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PlaceholderTextureLayered", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PlaceholderTextureLayered", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_layers(&mut self, layers: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PlaceholderTextureLayered", "set_layers", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`PlaceholderTextureLayered`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_PlaceholderTextureLayered {
        ($Class: ident) => {
