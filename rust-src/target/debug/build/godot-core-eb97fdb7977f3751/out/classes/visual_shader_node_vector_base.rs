...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`VisualShaderNodeVectorBase`][crate::classes::VisualShaderNodeVectorBase].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `VisualShaderNodeVectorBase` methods](https://docs.godotengine.org/en/stable/classes/class_visualshadernodevectorbase.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IVisualShaderNodeVectorBase: crate::obj::GodotClass < Base = VisualShaderNodeVectorBase > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeVectorBase {
        pub fn set_op_type(&mut self, type_: crate::classes::visual_shader_node_vector_base::OpType,) {
            type CallSig = ((), crate::classes::visual_shader_node_vector_base::OpType);
            let args = (type_,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10204usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVectorBase", "set_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_op_type(&self,) -> crate::classes::visual_shader_node_vector_base::OpType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVectorBase", "get_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeVectorBase`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeVectorBase {
        ($Class: ident) => {
