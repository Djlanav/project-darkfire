...
pub(super) mod re_export {
    ...
    impl Cubemap {
        pub fn create_placeholder(&self,) -> Option < Gd < crate::classes::Resource > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Cubemap", "create_placeholder", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Cubemap {
        ($Class: ident) => {
