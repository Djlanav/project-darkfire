...
pub(super) mod re_export {
    ...
    impl BoxContainer {
        pub fn add_spacer(&mut self, begin: bool,) -> Option < Gd < crate::classes::Control > > {
            type CallSig = (Option < Gd < crate::classes::Control > >, bool);
            let args = (begin,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1223usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BoxContainer", "add_spacer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_alignment(&mut self, alignment: crate::classes::box_container::AlignmentMode,) {
            type CallSig = ((), crate::classes::box_container::AlignmentMode);
            let args = (alignment,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1224usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BoxContainer", "set_alignment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_alignment(&self,) -> crate::classes::box_container::AlignmentMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BoxContainer", "get_alignment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertical(&mut self, vertical: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BoxContainer", "set_vertical", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_vertical(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "BoxContainer", "is_vertical", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_BoxContainer {
        ($Class: ident) => {
