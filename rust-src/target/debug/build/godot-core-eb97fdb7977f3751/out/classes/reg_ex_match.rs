...
pub(super) mod re_export {
    ...
    impl RegExMatch {
        pub fn get_subject(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_subject", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_group_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_group_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_names(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_names", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_strings(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_strings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_string_full(&self, name: RefArg < Variant >,) -> GString {
            type CallSig < 'a0, > = (GString, RefArg < 'a0, Variant >);
            let args = (name,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6941usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_string", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_start_full(&self, name: RefArg < Variant >,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_start", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_end_full(&self, name: RefArg < Variant >,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RegExMatch", "get_end", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RegExMatch {
        ($Class: ident) => {
