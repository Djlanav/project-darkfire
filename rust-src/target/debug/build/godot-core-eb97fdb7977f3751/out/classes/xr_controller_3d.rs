...
pub(super) mod re_export {
    ...
    impl XrController3D {
        pub fn is_button_pressed(&self, name: impl AsArg < StringName >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrController3D", "is_button_pressed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input(&self, name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrController3D", "get_input", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_float(&self, name: impl AsArg < StringName >,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrController3D", "get_float", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vector2(&self, name: impl AsArg < StringName >,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrController3D", "get_vector2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tracker_hand(&self,) -> crate::classes::xr_positional_tracker::TrackerHand {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "XrController3D", "get_tracker_hand", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_XrController3D {
        ($Class: ident) => {
