...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`RenderSceneData`][crate::classes::RenderSceneData].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `RenderSceneData` methods](https://docs.godotengine.org/en/stable/classes/class_renderscenedata.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IRenderSceneData: crate::obj::GodotClass < Base = RenderSceneData > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl RenderSceneData {
        pub fn get_cam_transform(&self,) -> Transform3D {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_cam_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cam_projection(&self,) -> Projection {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_cam_projection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_view_count(&self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_view_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_view_eye_offset(&self, view: u32,) -> Vector3 {
            type CallSig = (Vector3, u32);
            let args = (view,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7019usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_view_eye_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_view_projection(&self, view: u32,) -> Projection {
            type CallSig = (Projection, u32);
            let args = (view,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7020usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_view_projection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_uniform_buffer(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneData", "get_uniform_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`RenderSceneData`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_RenderSceneData {
        ($Class: ident) => {
