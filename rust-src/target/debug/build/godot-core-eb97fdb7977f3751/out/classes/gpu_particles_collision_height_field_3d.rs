...
pub(super) mod re_export {
    ...
    impl GpuParticlesCollisionHeightField3D {
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_resolution(&mut self, resolution: crate::classes::gpu_particles_collision_height_field_3d::Resolution,) {
            type CallSig = ((), crate::classes::gpu_particles_collision_height_field_3d::Resolution);
            let args = (resolution,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3847usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "set_resolution", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_resolution(&self,) -> crate::classes::gpu_particles_collision_height_field_3d::Resolution {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "get_resolution", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_mode(&mut self, update_mode: crate::classes::gpu_particles_collision_height_field_3d::UpdateMode,) {
            type CallSig = ((), crate::classes::gpu_particles_collision_height_field_3d::UpdateMode);
            let args = (update_mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3849usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "set_update_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_mode(&self,) -> crate::classes::gpu_particles_collision_height_field_3d::UpdateMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "get_update_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_follow_camera_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "set_follow_camera_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_follow_camera_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollisionHeightField3D", "is_follow_camera_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_GpuParticlesCollisionHeightField3D {
        ($Class: ident) => {
