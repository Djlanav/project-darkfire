...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`GpuParticlesAttractor3D`][crate::classes::GpuParticlesAttractor3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `GPUParticlesAttractor3D` methods](https://docs.godotengine.org/en/stable/classes/class_gpuparticlesattractor3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IGpuParticlesAttractor3D: crate::obj::GodotClass < Base = GpuParticlesAttractor3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl GpuParticlesAttractor3D {
        pub fn set_cull_mask(&mut self, mask: u32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "set_cull_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cull_mask(&self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "get_cull_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_strength(&mut self, strength: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "set_strength", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_strength(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "get_strength", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_attenuation(&mut self, attenuation: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "set_attenuation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attenuation(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "get_attenuation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_directionality(&mut self, amount: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "set_directionality", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_directionality(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesAttractor3D", "get_directionality", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`GpuParticlesAttractor3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_GpuParticlesAttractor3D {
        ($Class: ident) => {
