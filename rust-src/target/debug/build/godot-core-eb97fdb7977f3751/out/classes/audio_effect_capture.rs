...
pub(super) mod re_export {
    ...
    impl AudioEffectCapture {
        pub fn can_get_buffer(&self, frames: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "can_get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer(&mut self, frames: i32,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_buffer(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "clear_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffer_length(&mut self, buffer_length_seconds: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "set_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frames_available(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_frames_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_discarded_frames(&self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_discarded_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length_frames(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer_length_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pushed_frames(&self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_pushed_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_AudioEffectCapture {
        ($Class: ident) => {
