...
pub(super) mod re_export {
    ...
    impl InputEventScreenDrag {
        pub fn set_index(&mut self, index: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_index(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tilt(&mut self, tilt: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_tilt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tilt(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_tilt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pressure(&mut self, pressure: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_pressure", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pressure(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_pressure", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pen_inverted(&mut self, pen_inverted: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_pen_inverted", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pen_inverted(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_pen_inverted", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_position(&mut self, position: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_position(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_relative(&mut self, relative: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_relative", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_relative(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_relative", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_screen_relative(&mut self, relative: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_screen_relative", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_screen_relative(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_screen_relative", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_velocity(&mut self, velocity: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_velocity(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_screen_velocity(&mut self, velocity: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "set_screen_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_screen_velocity(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventScreenDrag", "get_screen_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_InputEventScreenDrag {
        ($Class: ident) => {
