...
pub(super) mod re_export {
    ...
    impl CollisionPolygon2D {
        pub fn set_polygon(&mut self, polygon: &PackedVector2Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "set_polygon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_polygon(&self,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "get_polygon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_build_mode(&mut self, build_mode: crate::classes::collision_polygon_2d::BuildMode,) {
            type CallSig = ((), crate::classes::collision_polygon_2d::BuildMode);
            let args = (build_mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2187usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "set_build_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_build_mode(&self,) -> crate::classes::collision_polygon_2d::BuildMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "get_build_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_disabled(&mut self, disabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "set_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_disabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "is_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_one_way_collision(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "set_one_way_collision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_one_way_collision_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "is_one_way_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_one_way_collision_margin(&mut self, margin: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "set_one_way_collision_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_one_way_collision_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CollisionPolygon2D", "get_one_way_collision_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_CollisionPolygon2D {
        ($Class: ident) => {
