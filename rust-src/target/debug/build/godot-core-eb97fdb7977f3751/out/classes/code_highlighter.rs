...
pub(super) mod re_export {
    ...
    impl CodeHighlighter {
        pub fn add_keyword_color(&mut self, keyword: impl AsArg < GString >, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "add_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_keyword_color(&mut self, keyword: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "remove_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_keyword_color(&self, keyword: impl AsArg < GString >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "has_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_keyword_color(&self, keyword: impl AsArg < GString >,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_keyword_colors(&mut self, keywords: &Dictionary,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_keyword_colors(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "clear_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_keyword_colors(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_member_keyword_color(&mut self, member_keyword: impl AsArg < GString >, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "add_member_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_member_keyword_color(&mut self, member_keyword: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "remove_member_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_member_keyword_color(&self, member_keyword: impl AsArg < GString >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "has_member_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_member_keyword_color(&self, member_keyword: impl AsArg < GString >,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_member_keyword_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_member_keyword_colors(&mut self, member_keyword: &Dictionary,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_member_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_member_keyword_colors(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "clear_member_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_member_keyword_colors(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_member_keyword_colors", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_color_region_full(&mut self, start_key: CowArg < GString >, end_key: CowArg < GString >, color: Color, line_only: bool,) {
            type CallSig < 'a0, 'a1, > = ((), CowArg < 'a0, GString >, CowArg < 'a1, GString >, Color, bool);
            let args = (start_key, end_key, color, line_only,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2105usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "add_color_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn remove_color_region(&mut self, start_key: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "remove_color_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_color_region(&self, start_key: impl AsArg < GString >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "has_color_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_color_regions(&mut self, color_regions: &Dictionary,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_color_regions", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_color_regions(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "clear_color_regions", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color_regions(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_color_regions", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_function_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_function_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_function_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_function_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_number_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_number_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_number_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_number_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_symbol_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_symbol_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_symbol_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_symbol_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_member_variable_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "set_member_variable_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_member_variable_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CodeHighlighter", "get_member_variable_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_CodeHighlighter {
        ($Class: ident) => {
