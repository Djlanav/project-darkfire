...
pub(super) mod re_export {
    ...
    impl Expression {
        pub(crate) fn parse_full(&mut self, expression: CowArg < GString >, input_names: RefArg < PackedStringArray >,) -> crate::global::Error {
            type CallSig < 'a0, 'a1, > = (crate::global::Error, CowArg < 'a0, GString >, RefArg < 'a1, PackedStringArray >);
            let args = (expression, input_names,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3098usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Expression", "parse", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn execute_full(&mut self, inputs: RefArg < VariantArray >, base_instance: ObjectArg < crate::classes::Object >, show_error: bool, const_calls_only: bool,) -> Variant {
            type CallSig < 'a0, > = (Variant, RefArg < 'a0, VariantArray >, ObjectArg < crate::classes::Object >, bool, bool);
            let args = (inputs, base_instance, show_error, const_calls_only,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3099usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Expression", "execute", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn has_execute_failed(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Expression", "has_execute_failed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_error_text(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Expression", "get_error_text", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Expression {
        ($Class: ident) => {
