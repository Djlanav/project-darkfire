...
pub(super) mod re_export {
    ...
    impl Container {
        pub fn queue_sort(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Container", "queue_sort", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn fit_child_in_rect(&mut self, child: impl AsObjectArg < crate::classes::Control >, rect: Rect2,) {
            type CallSig = ((), ObjectArg < crate::classes::Control >, Rect2);
            let args = (child.as_object_arg(), rect,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2290usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Container", "fit_child_in_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Container {
        ($Class: ident) => {
