...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`SkinReference`][crate::classes::SkinReference].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `SkinReference` methods](https://docs.godotengine.org/en/stable/classes/class_skinreference.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ISkinReference: crate::obj::GodotClass < Base = SkinReference > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl SkinReference {
        pub fn get_skeleton(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkinReference", "get_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skin(&self,) -> Option < Gd < crate::classes::Skin > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkinReference", "get_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`SkinReference`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_SkinReference {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::SkinReference > for $Class {
