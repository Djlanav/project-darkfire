...
pub(super) mod re_export {
    ...
    impl RdUniform {
        pub fn set_uniform_type(&mut self, p_member: crate::classes::rendering_device::UniformType,) {
            type CallSig = ((), crate::classes::rendering_device::UniformType);
            let args = (p_member,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6773usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "set_uniform_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_uniform_type(&self,) -> crate::classes::rendering_device::UniformType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "get_uniform_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_binding(&mut self, p_member: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "set_binding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_binding(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "get_binding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_id(&mut self, id: Rid,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "add_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_ids(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "clear_ids", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ids(&self,) -> Array < Rid > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdUniform", "get_ids", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RdUniform {
        ($Class: ident) => {
