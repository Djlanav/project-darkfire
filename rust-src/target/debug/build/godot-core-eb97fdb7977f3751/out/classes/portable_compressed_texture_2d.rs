...
pub(super) mod re_export {
    ...
    impl PortableCompressedTexture2D {
        pub(crate) fn create_from_image_full(&mut self, image: ObjectArg < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode, normal_map: bool, lossy_quality: f32,) {
            type CallSig = ((), ObjectArg < crate::classes::Image >, crate::classes::portable_compressed_texture_2d::CompressionMode, bool, f32);
            let args = (image, compression_mode, normal_map, lossy_quality,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6479usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "create_from_image", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_format(&self,) -> crate::classes::image::Format {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "get_format", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_compression_mode(&self,) -> crate::classes::portable_compressed_texture_2d::CompressionMode {
            type CallSig = (crate::classes::portable_compressed_texture_2d::CompressionMode,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6481usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "get_compression_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_size_override(&mut self, size: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "set_size_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size_override(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "get_size_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_keep_compressed_buffer(&mut self, keep: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "set_keep_compressed_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_keeping_compressed_buffer(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "is_keeping_compressed_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_keep_all_compressed_buffers(keep: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "set_keep_all_compressed_buffers", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn is_keeping_all_compressed_buffers() -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PortableCompressedTexture2D", "is_keeping_all_compressed_buffers", std::ptr::null_mut(), None, args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PortableCompressedTexture2D {
        ($Class: ident) => {
