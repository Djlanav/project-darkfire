...
pub(super) mod re_export {
    ...
    impl CryptoKey {
        pub(crate) fn save_full(&mut self, path: CowArg < GString >, public_only: bool,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CryptoKey", "save", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn load_full(&mut self, path: CowArg < GString >, public_only: bool,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CryptoKey", "load", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn is_public_only(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CryptoKey", "is_public_only", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn save_to_string_full(&mut self, public_only: bool,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CryptoKey", "save_to_string", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn load_from_string_full(&mut self, string_key: CowArg < GString >, public_only: bool,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CryptoKey", "load_from_string", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_CryptoKey {
        ($Class: ident) => {
