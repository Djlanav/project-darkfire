...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`AudioStreamPlaybackInteractive`][crate::classes::AudioStreamPlaybackInteractive].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `AudioStreamPlaybackInteractive` methods](https://docs.godotengine.org/en/stable/classes/class_audiostreamplaybackinteractive.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IAudioStreamPlaybackInteractive: crate::obj::GodotClass < Base = AudioStreamPlaybackInteractive > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl AudioStreamPlaybackInteractive {
        pub fn switch_to_clip_by_name(&mut self, clip_name: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamPlaybackInteractive", "switch_to_clip_by_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn switch_to_clip(&mut self, clip_index: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamPlaybackInteractive", "switch_to_clip", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`AudioStreamPlaybackInteractive`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_AudioStreamPlaybackInteractive {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::AudioStreamPlaybackInteractive > for $Class {
