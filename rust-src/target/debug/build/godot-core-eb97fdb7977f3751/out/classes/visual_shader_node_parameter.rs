...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`VisualShaderNodeParameter`][crate::classes::VisualShaderNodeParameter].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `VisualShaderNodeParameter` methods](https://docs.godotengine.org/en/stable/classes/class_visualshadernodeparameter.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IVisualShaderNodeParameter: crate::obj::GodotClass < Base = VisualShaderNodeParameter > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeParameter {
        pub fn set_parameter_name(&mut self, name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParameter", "set_parameter_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_parameter_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParameter", "get_parameter_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_qualifier(&mut self, qualifier: crate::classes::visual_shader_node_parameter::Qualifier,) {
            type CallSig = ((), crate::classes::visual_shader_node_parameter::Qualifier);
            let args = (qualifier,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10107usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParameter", "set_qualifier", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_qualifier(&self,) -> crate::classes::visual_shader_node_parameter::Qualifier {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParameter", "get_qualifier", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeParameter`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeParameter {
        ($Class: ident) => {
