...
pub(super) mod re_export {
    ...
    impl TextureLayered {
        pub fn get_format(&self,) -> crate::classes::image::Format {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_format", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_layered_type(&self,) -> crate::classes::texture_layered::LayeredType {
            type CallSig = (crate::classes::texture_layered::LayeredType,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8959usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_layered_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_width(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_height(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_layers(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_layers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_mipmaps(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "has_mipmaps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_layer_data(&self, layer: i32,) -> Option < Gd < crate::classes::Image > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TextureLayered", "get_layer_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TextureLayered {
        ($Class: ident) => {
