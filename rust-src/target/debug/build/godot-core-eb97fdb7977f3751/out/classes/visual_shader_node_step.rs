...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeStep {
        pub fn set_op_type(&mut self, op_type: crate::classes::visual_shader_node_step::OpType,) {
            type CallSig = ((), crate::classes::visual_shader_node_step::OpType);
            let args = (op_type,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10134usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeStep", "set_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_op_type(&self,) -> crate::classes::visual_shader_node_step::OpType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeStep", "get_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeStep {
        ($Class: ident) => {
