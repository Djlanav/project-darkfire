...
pub(super) mod re_export {
    ...
    impl MenuButton {
        pub fn get_popup(&self,) -> Option < Gd < crate::classes::PopupMenu > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "get_popup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn show_popup(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "show_popup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_switch_on_hover(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "set_switch_on_hover", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_switch_on_hover(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "is_switch_on_hover", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_disable_shortcuts(&mut self, disabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "set_disable_shortcuts", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_count(&mut self, count: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "set_item_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MenuButton", "get_item_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_MenuButton {
        ($Class: ident) => {
