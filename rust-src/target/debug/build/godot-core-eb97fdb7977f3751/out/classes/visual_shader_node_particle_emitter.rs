...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`VisualShaderNodeParticleEmitter`][crate::classes::VisualShaderNodeParticleEmitter].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `VisualShaderNodeParticleEmitter` methods](https://docs.godotengine.org/en/stable/classes/class_visualshadernodeparticleemitter.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IVisualShaderNodeParticleEmitter: crate::obj::GodotClass < Base = VisualShaderNodeParticleEmitter > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeParticleEmitter {
        pub fn set_mode_2d(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParticleEmitter", "set_mode_2d", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_mode_2d(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParticleEmitter", "is_mode_2d", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeParticleEmitter`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeParticleEmitter {
        ($Class: ident) => {
