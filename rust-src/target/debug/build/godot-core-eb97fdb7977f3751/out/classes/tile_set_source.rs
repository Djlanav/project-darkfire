...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`TileSetSource`][crate::classes::TileSetSource].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `TileSetSource` methods](https://docs.godotengine.org/en/stable/classes/class_tilesetsource.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ITileSetSource: crate::obj::GodotClass < Base = TileSetSource > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl TileSetSource {
        pub fn get_tiles_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "get_tiles_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tile_id(&self, index: i32,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "get_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_tile(&self, atlas_coords: Vector2i,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "has_tile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_alternative_tiles_count(&self, atlas_coords: Vector2i,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "get_alternative_tiles_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_alternative_tile_id(&self, atlas_coords: Vector2i, index: i32,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "get_alternative_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_alternative_tile(&self, atlas_coords: Vector2i, alternative_tile: i32,) -> bool {
            type CallSig = (bool, Vector2i, i32);
            let args = (atlas_coords, alternative_tile,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9387usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetSource", "has_alternative_tile", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`TileSetSource`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_TileSetSource {
        ($Class: ident) => {
