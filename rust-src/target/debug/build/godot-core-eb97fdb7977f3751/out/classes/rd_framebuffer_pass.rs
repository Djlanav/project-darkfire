...
pub(super) mod re_export {
    ...
    impl RdFramebufferPass {
        pub fn set_color_attachments(&mut self, p_member: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "set_color_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "get_color_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_input_attachments(&mut self, p_member: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "set_input_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "get_input_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_resolve_attachments(&mut self, p_member: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "set_resolve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_resolve_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "get_resolve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_preserve_attachments(&mut self, p_member: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "set_preserve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_preserve_attachments(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "get_preserve_attachments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_depth_attachment(&mut self, p_member: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "set_depth_attachment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_depth_attachment(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RdFramebufferPass", "get_depth_attachment", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RdFramebufferPass {
        ($Class: ident) => {
