...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`ScriptEditorBase`][crate::classes::ScriptEditorBase].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `ScriptEditorBase` methods](https://docs.godotengine.org/en/stable/classes/class_scripteditorbase.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IScriptEditorBase: crate::obj::GodotClass < Base = ScriptEditorBase > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ScriptEditorBase {
        pub fn get_base_editor(&self,) -> Option < Gd < crate::classes::Control > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ScriptEditorBase", "get_base_editor", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_syntax_highlighter(&mut self, highlighter: impl AsObjectArg < crate::classes::EditorSyntaxHighlighter >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ScriptEditorBase", "add_syntax_highlighter", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ScriptEditorBase`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_ScriptEditorBase {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::ScriptEditorBase > for $Class {
