...
pub(super) mod re_export {
    ...
    impl WebSocketMultiplayerPeer {
        pub(crate) fn create_client_full(&mut self, url: CowArg < GString >, tls_client_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "create_client", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_server_full(&mut self, port: i32, bind_address: CowArg < GString >, tls_server_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallSig < 'a0, > = (crate::global::Error, i32, CowArg < 'a0, GString >, ObjectArg < crate::classes::TlsOptions >);
            let args = (port, bind_address, tls_server_options,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10277usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "create_server", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_peer(&self, peer_id: i32,) -> Option < Gd < crate::classes::WebSocketPeer > > {
            type CallSig = (Option < Gd < crate::classes::WebSocketPeer > >, i32);
            let args = (peer_id,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10278usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_peer_address(&self, id: i32,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_peer_address", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_peer_port(&self, id: i32,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_peer_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_supported_protocols(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_supported_protocols", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_supported_protocols(&mut self, protocols: &PackedStringArray,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_supported_protocols", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_handshake_headers(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_handshake_headers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_handshake_headers(&mut self, protocols: &PackedStringArray,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_handshake_headers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inbound_buffer_size(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_inbound_buffer_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_inbound_buffer_size(&mut self, buffer_size: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_inbound_buffer_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_outbound_buffer_size(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_outbound_buffer_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_outbound_buffer_size(&mut self, buffer_size: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_outbound_buffer_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_handshake_timeout(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_handshake_timeout", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_handshake_timeout(&mut self, timeout: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_handshake_timeout", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max_queued_packets(&mut self, max_queued_packets: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "set_max_queued_packets", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max_queued_packets(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebSocketMultiplayerPeer", "get_max_queued_packets", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_WebSocketMultiplayerPeer {
        ($Class: ident) => {
