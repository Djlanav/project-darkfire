...
pub(super) mod re_export {
    ...
    impl RandomNumberGenerator {
        pub fn set_seed(&mut self, seed: u64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "set_seed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_seed(&mut self,) -> u64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "get_seed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_state(&mut self, state: u64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "set_state", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_state(&self,) -> u64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "get_state", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn randi(&mut self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randi", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn randf(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randf", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn randfn_full(&mut self, mean: f32, deviation: f32,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randfn", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn randf_range(&mut self, from: f32, to: f32,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randf_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn randi_range(&mut self, from: i32, to: i32,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randi_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn rand_weighted(&mut self, weights: &PackedFloat32Array,) -> i64 {
            type CallSig < 'a0, > = (i64, RefArg < 'a0, PackedFloat32Array >);
            let args = (RefArg::new(weights),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6799usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "rand_weighted", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn randomize(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RandomNumberGenerator", "randomize", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RandomNumberGenerator {
        ($Class: ident) => {
