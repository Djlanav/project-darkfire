...
pub(super) mod re_export {
    ...
    impl OpenXrAction {
        pub fn set_localized_name(&mut self, localized_name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_localized_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_localized_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_localized_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_action_type(&mut self, action_type: crate::classes::open_xr_action::ActionType,) {
            type CallSig = ((), crate::classes::open_xr_action::ActionType);
            let args = (action_type,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5713usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_action_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_action_type(&self,) -> crate::classes::open_xr_action::ActionType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_action_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_toplevel_paths(&mut self, toplevel_paths: &PackedStringArray,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_toplevel_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_toplevel_paths(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_toplevel_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_OpenXrAction {
        ($Class: ident) => {
