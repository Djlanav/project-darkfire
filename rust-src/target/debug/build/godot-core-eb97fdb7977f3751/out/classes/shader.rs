...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`Shader`][crate::classes::Shader].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `Shader` methods](https://docs.godotengine.org/en/stable/classes/class_shader.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IShader: crate::obj::GodotClass < Base = Shader > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl Shader {
        pub fn get_mode(&self,) -> crate::classes::shader::Mode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "get_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_code(&mut self, code: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "set_code", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_code(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "get_code", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn set_default_texture_parameter_full(&mut self, name: CowArg < StringName >, texture: ObjectArg < crate::classes::Texture2D >, index: i32,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, StringName >, ObjectArg < crate::classes::Texture2D >, i32);
            let args = (name, texture, index,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7573usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "set_default_texture_parameter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        #[inline]
        pub fn set_default_texture_parameter(&mut self, name: impl AsArg < StringName >, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            self.set_default_texture_parameter_ex(name, texture,) . done()
        }
        #[inline]
        pub fn set_default_texture_parameter_ex < 'a > (&'a mut self, name: impl AsArg < StringName > + 'a, texture: impl AsObjectArg < crate::classes::Texture2D >,) -> ExSetDefaultTextureParameter < 'a > {
            ExSetDefaultTextureParameter::new(self, name, texture,)
        }
        pub(crate) fn get_default_texture_parameter_full(&self, name: CowArg < StringName >, index: i32,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "get_default_texture_parameter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        #[inline]
        pub fn get_default_texture_parameter(&self, name: impl AsArg < StringName >,) -> Option < Gd < crate::classes::Texture2D > > {
        ...
        pub(crate) fn get_shader_uniform_list_full(&mut self, get_groups: bool,) -> VariantArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shader", "get_shader_uniform_list", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`Shader`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_Shader {
        ($Class: ident) => {
...
pub struct ExSetDefaultTextureParameter < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::Shader, name: CowArg < 'a, StringName >, texture: ObjectCow < crate::classes::Texture2D >, index: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExSetDefaultTextureParameter < 'a > {
    fn new(surround_object: &'a mut re_export::Shader, name: impl AsArg < StringName > + 'a, texture: impl AsObjectArg < crate::classes::Texture2D >,) -> Self {
        let index = 0i32;
        Self {
