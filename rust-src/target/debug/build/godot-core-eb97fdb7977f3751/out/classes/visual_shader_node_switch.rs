...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeSwitch {
        pub fn set_op_type(&mut self, type_: crate::classes::visual_shader_node_switch::OpType,) {
            type CallSig = ((), crate::classes::visual_shader_node_switch::OpType);
            let args = (type_,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10136usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeSwitch", "set_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_op_type(&self,) -> crate::classes::visual_shader_node_switch::OpType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeSwitch", "get_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeSwitch {
        ($Class: ident) => {
