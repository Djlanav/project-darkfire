...
pub(super) mod re_export {
    ...
    impl PlaceholderMesh {
        pub fn set_aabb(&mut self, aabb: Aabb,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PlaceholderMesh", "set_aabb", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PlaceholderMesh {
        ($Class: ident) => {
