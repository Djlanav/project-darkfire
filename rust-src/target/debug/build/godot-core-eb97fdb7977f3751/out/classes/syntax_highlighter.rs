...
pub(super) mod re_export {
    ...
    impl SyntaxHighlighter {
        pub fn get_line_syntax_highlighting(&mut self, line: i32,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "get_line_syntax_highlighting", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_cache(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "update_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_highlighting_cache(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "clear_highlighting_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_text_edit(&self,) -> Option < Gd < crate::classes::TextEdit > > {
            type CallSig = (Option < Gd < crate::classes::TextEdit > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8186usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "get_text_edit", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_SyntaxHighlighter {
        ($Class: ident) => {
