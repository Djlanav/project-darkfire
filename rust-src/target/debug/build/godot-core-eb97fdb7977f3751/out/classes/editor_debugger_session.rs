...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`EditorDebuggerSession`][crate::classes::EditorDebuggerSession].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `EditorDebuggerSession` methods](https://docs.godotengine.org/en/stable/classes/class_editordebuggersession.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IEditorDebuggerSession: crate::obj::GodotClass < Base = EditorDebuggerSession > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl EditorDebuggerSession {
        pub(crate) fn send_message_full(&mut self, message: CowArg < GString >, data: RefArg < VariantArray >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "send_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn toggle_profiler_full(&mut self, profiler: CowArg < GString >, enable: bool, data: RefArg < VariantArray >,) {
            type CallSig < 'a0, 'a1, > = ((), CowArg < 'a0, GString >, bool, RefArg < 'a1, VariantArray >);
            let args = (profiler, enable, data,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(5usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "toggle_profiler", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn is_breaked(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "is_breaked", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_debuggable(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "is_debuggable", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_active(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "is_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_session_tab(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "add_session_tab", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_session_tab(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "remove_session_tab", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_breakpoint(&mut self, path: impl AsArg < GString >, line: i32, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerSession", "set_breakpoint", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`EditorDebuggerSession`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_EditorDebuggerSession {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::EditorDebuggerSession > for $Class {
