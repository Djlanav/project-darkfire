...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`GpuParticlesCollision3D`][crate::classes::GpuParticlesCollision3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `GPUParticlesCollision3D` methods](https://docs.godotengine.org/en/stable/classes/class_gpuparticlescollision3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IGpuParticlesCollision3D: crate::obj::GodotClass < Base = GpuParticlesCollision3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl GpuParticlesCollision3D {
        pub fn set_cull_mask(&mut self, mask: u32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollision3D", "set_cull_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cull_mask(&self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GpuParticlesCollision3D", "get_cull_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`GpuParticlesCollision3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_GpuParticlesCollision3D {
        ($Class: ident) => {
