...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`InputEventFromWindow`][crate::classes::InputEventFromWindow].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `InputEventFromWindow` methods](https://docs.godotengine.org/en/stable/classes/class_inputeventfromwindow.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IInputEventFromWindow: crate::obj::GodotClass < Base = InputEventFromWindow > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl InputEventFromWindow {
        pub fn set_window_id(&mut self, id: i64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventFromWindow", "set_window_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_window_id(&self,) -> i64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventFromWindow", "get_window_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`InputEventFromWindow`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_InputEventFromWindow {
        ($Class: ident) => {
