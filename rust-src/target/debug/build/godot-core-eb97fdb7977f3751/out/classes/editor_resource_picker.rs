...
pub(super) mod re_export {
    ...
    impl EditorResourcePicker {
        pub fn set_base_type(&mut self, base_type: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "set_base_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_base_type(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "get_base_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_allowed_types(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "get_allowed_types", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_edited_resource(&mut self, resource: impl AsObjectArg < crate::classes::Resource >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "set_edited_resource", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edited_resource(&mut self,) -> Option < Gd < crate::classes::Resource > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "get_edited_resource", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_toggle_mode(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "set_toggle_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_toggle_mode(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "is_toggle_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_toggle_pressed(&mut self, pressed: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "set_toggle_pressed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_editable(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "set_editable", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_editable(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorResourcePicker", "is_editable", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorResourcePicker {
        ($Class: ident) => {
