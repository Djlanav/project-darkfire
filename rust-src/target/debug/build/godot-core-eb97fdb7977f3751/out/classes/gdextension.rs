...
pub(super) mod re_export {
    ...
    impl GDExtension {
        pub fn is_library_open(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GDExtension", "is_library_open", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_minimum_library_initialization_level(&self,) -> crate::classes::gdextension::InitializationLevel {
            type CallSig = (crate::classes::gdextension::InitializationLevel,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3417usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GDExtension", "get_minimum_library_initialization_level", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_GDExtension {
        ($Class: ident) => {
