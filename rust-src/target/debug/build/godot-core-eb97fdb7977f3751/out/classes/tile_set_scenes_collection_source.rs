...
pub(super) mod re_export {
    ...
    impl TileSetScenesCollectionSource {
        pub fn get_scene_tiles_count(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "get_scene_tiles_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scene_tile_id(&mut self, index: i32,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "get_scene_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_scene_tile_id(&mut self, id: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "has_scene_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn create_scene_tile_full(&mut self, packed_scene: ObjectArg < crate::classes::PackedScene >, id_override: i32,) -> i32 {
            type CallSig = (i32, ObjectArg < crate::classes::PackedScene >, i32);
            let args = (packed_scene, id_override,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9374usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "create_scene_tile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_scene_tile_id(&mut self, id: i32, new_id: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "set_scene_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_scene_tile_scene(&mut self, id: i32, packed_scene: impl AsObjectArg < crate::classes::PackedScene >,) {
            type CallSig = ((), i32, ObjectArg < crate::classes::PackedScene >);
            let args = (id, packed_scene.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9376usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "set_scene_tile_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scene_tile_scene(&self, id: i32,) -> Option < Gd < crate::classes::PackedScene > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "get_scene_tile_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_scene_tile_display_placeholder(&mut self, id: i32, display_placeholder: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "set_scene_tile_display_placeholder", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scene_tile_display_placeholder(&self, id: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "get_scene_tile_display_placeholder", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_scene_tile(&mut self, id: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "remove_scene_tile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_next_scene_tile_id(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileSetScenesCollectionSource", "get_next_scene_tile_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TileSetScenesCollectionSource {
        ($Class: ident) => {
