...
pub(super) mod re_export {
    ...
    impl SceneReplicationConfig {
        pub fn get_properties(&self,) -> Array < NodePath > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "get_properties", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_property_full(&mut self, path: CowArg < NodePath >, index: i32,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, NodePath >, i32);
            let args = (path, index,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7441usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "add_property", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn has_property(&self, path: impl AsArg < NodePath >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "has_property", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_property(&mut self, path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "remove_property", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_get_index(&self, path: impl AsArg < NodePath >,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_get_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_get_spawn(&mut self, path: impl AsArg < NodePath >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_get_spawn", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_set_spawn(&mut self, path: impl AsArg < NodePath >, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_set_spawn", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_get_replication_mode(&mut self, path: impl AsArg < NodePath >,) -> crate::classes::scene_replication_config::ReplicationMode {
            type CallSig < 'a0, > = (crate::classes::scene_replication_config::ReplicationMode, CowArg < 'a0, NodePath >);
            let args = (path.into_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7447usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_get_replication_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_set_replication_mode(&mut self, path: impl AsArg < NodePath >, mode: crate::classes::scene_replication_config::ReplicationMode,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, NodePath >, crate::classes::scene_replication_config::ReplicationMode);
            let args = (path.into_arg(), mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7448usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_set_replication_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_get_sync(&mut self, path: impl AsArg < NodePath >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_get_sync", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_set_sync(&mut self, path: impl AsArg < NodePath >, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_set_sync", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_get_watch(&mut self, path: impl AsArg < NodePath >,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_get_watch", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn property_set_watch(&mut self, path: impl AsArg < NodePath >, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SceneReplicationConfig", "property_set_watch", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_SceneReplicationConfig {
        ($Class: ident) => {
