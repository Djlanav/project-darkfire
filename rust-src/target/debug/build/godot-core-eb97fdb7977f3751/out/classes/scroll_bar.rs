...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`ScrollBar`][crate::classes::ScrollBar].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `ScrollBar` methods](https://docs.godotengine.org/en/stable/classes/class_scrollbar.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IScrollBar: crate::obj::GodotClass < Base = ScrollBar > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ScrollBar {
        pub fn set_custom_step(&mut self, step: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ScrollBar", "set_custom_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_custom_step(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ScrollBar", "get_custom_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ScrollBar`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_ScrollBar {
        ($Class: ident) => {
