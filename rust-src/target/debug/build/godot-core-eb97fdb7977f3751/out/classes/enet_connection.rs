...
pub(super) mod re_export {
    ...
    impl ENetConnection {
        pub(crate) fn create_host_bound_full(&mut self, bind_address: CowArg < GString >, bind_port: i32, max_peers: i32, max_channels: i32, in_bandwidth: i32, out_bandwidth: i32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "create_host_bound", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_host_full(&mut self, max_peers: i32, max_channels: i32, in_bandwidth: i32, out_bandwidth: i32,) -> crate::global::Error {
            type CallSig = (crate::global::Error, i32, i32, i32, i32);
            let args = (max_peers, max_channels, in_bandwidth, out_bandwidth,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2813usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "create_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn destroy(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "destroy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn connect_to_host_full(&mut self, address: CowArg < GString >, port: i32, channels: i32, data: i32,) -> Option < Gd < crate::classes::ENetPacketPeer > > {
            type CallSig < 'a0, > = (Option < Gd < crate::classes::ENetPacketPeer > >, CowArg < 'a0, GString >, i32, i32, i32);
            let args = (address, port, channels, data,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2815usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "connect_to_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn service_full(&mut self, timeout: i32,) -> VariantArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "service", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn flush(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "flush", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn bandwidth_limit_full(&mut self, in_bandwidth: i32, out_bandwidth: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "bandwidth_limit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn channel_limit(&mut self, limit: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "channel_limit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn broadcast(&mut self, channel: i32, packet: &PackedByteArray, flags: i32,) {
            type CallSig < 'a0, > = ((), i32, RefArg < 'a0, PackedByteArray >, i32);
            let args = (channel, RefArg::new(packet), flags,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2820usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "broadcast", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn compress(&mut self, mode: crate::classes::enet_connection::CompressionMode,) {
            type CallSig = ((), crate::classes::enet_connection::CompressionMode);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2821usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "compress", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn dtls_server_setup(&mut self, server_options: impl AsObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallSig = (crate::global::Error, ObjectArg < crate::classes::TlsOptions >);
            let args = (server_options.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2822usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "dtls_server_setup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn dtls_client_setup_full(&mut self, hostname: CowArg < GString >, client_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "dtls_client_setup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn refuse_new_connections(&mut self, refuse: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "refuse_new_connections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn pop_statistic(&mut self, statistic: crate::classes::enet_connection::HostStatistic,) -> f64 {
            type CallSig = (f64, crate::classes::enet_connection::HostStatistic);
            let args = (statistic,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2825usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "pop_statistic", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max_channels(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "get_max_channels", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "get_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_peers(&mut self,) -> Array < Gd < crate::classes::ENetPacketPeer > > {
            type CallSig = (Array < Gd < crate::classes::ENetPacketPeer > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2828usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "get_peers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn socket_send(&mut self, destination_address: impl AsArg < GString >, destination_port: i32, packet: &PackedByteArray,) {
            type CallSig < 'a0, 'a1, > = ((), CowArg < 'a0, GString >, i32, RefArg < 'a1, PackedByteArray >);
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ENetConnection", "socket_send", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ENetConnection {
        ($Class: ident) => {
