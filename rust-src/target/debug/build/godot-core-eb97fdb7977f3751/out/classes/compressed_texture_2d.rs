...
pub(super) mod re_export {
    ...
    impl CompressedTexture2D {
        pub fn load(&mut self, path: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CompressedTexture2D", "load", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_load_path(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CompressedTexture2D", "get_load_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_CompressedTexture2D {
        ($Class: ident) => {
