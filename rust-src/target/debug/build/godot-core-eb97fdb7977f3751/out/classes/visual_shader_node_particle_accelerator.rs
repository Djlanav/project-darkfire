...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeParticleAccelerator {
        pub fn set_mode(&mut self, mode: crate::classes::visual_shader_node_particle_accelerator::Mode,) {
            type CallSig = ((), crate::classes::visual_shader_node_particle_accelerator::Mode);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10111usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParticleAccelerator", "set_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mode(&self,) -> crate::classes::visual_shader_node_particle_accelerator::Mode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeParticleAccelerator", "get_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeParticleAccelerator {
        ($Class: ident) => {
