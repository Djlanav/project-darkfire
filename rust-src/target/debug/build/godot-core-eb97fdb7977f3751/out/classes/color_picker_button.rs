...
pub(super) mod re_export {
    ...
    impl ColorPickerButton {
        pub fn set_pick_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "set_pick_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pick_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "get_pick_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_picker(&mut self,) -> Option < Gd < crate::classes::ColorPicker > > {
            type CallSig = (Option < Gd < crate::classes::ColorPicker > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2249usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "get_picker", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_popup(&mut self,) -> Option < Gd < crate::classes::PopupPanel > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "get_popup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_edit_alpha(&mut self, show: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "set_edit_alpha", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_editing_alpha(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ColorPickerButton", "is_editing_alpha", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ColorPickerButton {
        ($Class: ident) => {
