...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`CsgPrimitive3D`][crate::classes::CsgPrimitive3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `CSGPrimitive3D` methods](https://docs.godotengine.org/en/stable/classes/class_csgprimitive3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ICsgPrimitive3D: crate::obj::GodotClass < Base = CsgPrimitive3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl CsgPrimitive3D {
        pub fn set_flip_faces(&mut self, flip_faces: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CsgPrimitive3D", "set_flip_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_flip_faces(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CsgPrimitive3D", "get_flip_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`CsgPrimitive3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_CsgPrimitive3D {
        ($Class: ident) => {
