...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`VisualShaderNodeVarying`][crate::classes::VisualShaderNodeVarying].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `VisualShaderNodeVarying` methods](https://docs.godotengine.org/en/stable/classes/class_visualshadernodevarying.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IVisualShaderNodeVarying: crate::obj::GodotClass < Base = VisualShaderNodeVarying > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeVarying {
        pub fn set_varying_name(&mut self, name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVarying", "set_varying_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_varying_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVarying", "get_varying_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_varying_type(&mut self, type_: crate::classes::visual_shader::VaryingType,) {
            type CallSig = ((), crate::classes::visual_shader::VaryingType);
            let args = (type_,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10184usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVarying", "set_varying_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_varying_type(&self,) -> crate::classes::visual_shader::VaryingType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeVarying", "get_varying_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeVarying`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeVarying {
        ($Class: ident) => {
