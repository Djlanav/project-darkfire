...
pub(super) mod re_export {
    ...
    impl Resource {
        pub fn set_path(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "set_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn take_over_path(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "take_over_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_path(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "get_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_name(&mut self, name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "set_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "get_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rid(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "get_rid", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_local_to_scene(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "set_local_to_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_local_to_scene(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "is_local_to_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_scene(&self,) -> Option < Gd < crate::classes::Node > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "get_local_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn setup_local_to_scene(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "setup_local_to_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn generate_scene_unique_id() -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "generate_scene_unique_id", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn set_scene_unique_id(&mut self, id: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "set_scene_unique_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scene_unique_id(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "get_scene_unique_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn emit_changed(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "emit_changed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn duplicate_full(&self, subresources: bool,) -> Option < Gd < crate::classes::Resource > > {
            type CallSig = (Option < Gd < crate::classes::Resource > >, bool);
            let args = (subresources,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7134usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Resource", "duplicate", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Resource {
        ($Class: ident) => {
