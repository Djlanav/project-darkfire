...
pub(super) mod re_export {
    ...
    impl Upnp {
        pub fn get_device_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "get_device_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_device(&self, index: i32,) -> Option < Gd < crate::classes::UpnpDevice > > {
            type CallSig = (Option < Gd < crate::classes::UpnpDevice > >, i32);
            let args = (index,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9682usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "get_device", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_device(&mut self, device: impl AsObjectArg < crate::classes::UpnpDevice >,) {
            type CallSig = ((), ObjectArg < crate::classes::UpnpDevice >);
            let args = (device.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9683usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "add_device", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_device(&mut self, index: i32, device: impl AsObjectArg < crate::classes::UpnpDevice >,) {
            type CallSig = ((), i32, ObjectArg < crate::classes::UpnpDevice >);
            let args = (index, device.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9684usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "set_device", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_device(&mut self, index: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "remove_device", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_devices(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "clear_devices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_gateway(&self,) -> Option < Gd < crate::classes::UpnpDevice > > {
            type CallSig = (Option < Gd < crate::classes::UpnpDevice > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9687usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "get_gateway", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn discover_full(&mut self, timeout: i32, ttl: i32, device_filter: CowArg < GString >,) -> i32 {
            type CallSig < 'a0, > = (i32, i32, i32, CowArg < 'a0, GString >);
            let args = (timeout, ttl, device_filter,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9688usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "discover", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn query_external_address(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "query_external_address", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_port_mapping_full(&self, port: i32, port_internal: i32, desc: CowArg < GString >, proto: CowArg < GString >, duration: i32,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "add_port_mapping", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn delete_port_mapping_full(&self, port: i32, proto: CowArg < GString >,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "delete_port_mapping", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_discover_multicast_if(&mut self, m_if: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "set_discover_multicast_if", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_discover_multicast_if(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "get_discover_multicast_if", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_discover_local_port(&mut self, port: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "set_discover_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_discover_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "get_discover_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_discover_ipv6(&mut self, ipv6: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "set_discover_ipv6", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_discover_ipv6(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Upnp", "is_discover_ipv6", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Upnp {
        ($Class: ident) => {
