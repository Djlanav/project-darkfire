...
pub(super) mod re_export {
    ...
    impl RenderSceneBuffersConfiguration {
        pub fn get_render_target(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_render_target", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_render_target(&mut self, render_target: Rid,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_render_target", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_internal_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_internal_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_internal_size(&mut self, internal_size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_internal_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_target_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_target_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_target_size(&mut self, target_size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_target_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_view_count(&self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_view_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_view_count(&mut self, view_count: u32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_view_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scaling_3d_mode(&self,) -> crate::classes::rendering_server::ViewportScaling3DMode {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_scaling_3d_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_scaling_3d_mode(&mut self, scaling_3d_mode: crate::classes::rendering_server::ViewportScaling3DMode,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_scaling_3d_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_msaa_3d(&self,) -> crate::classes::rendering_server::ViewportMsaa {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_msaa_3d", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_msaa_3d(&mut self, msaa_3d: crate::classes::rendering_server::ViewportMsaa,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_msaa_3d", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_screen_space_aa(&self,) -> crate::classes::rendering_server::ViewportScreenSpaceAa {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_screen_space_aa", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_screen_space_aa(&mut self, screen_space_aa: crate::classes::rendering_server::ViewportScreenSpaceAa,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_screen_space_aa", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fsr_sharpness(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_fsr_sharpness", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fsr_sharpness(&mut self, fsr_sharpness: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_fsr_sharpness", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_mipmap_bias(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "get_texture_mipmap_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_mipmap_bias(&mut self, texture_mipmap_bias: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffersConfiguration", "set_texture_mipmap_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_RenderSceneBuffersConfiguration {
        ($Class: ident) => {
