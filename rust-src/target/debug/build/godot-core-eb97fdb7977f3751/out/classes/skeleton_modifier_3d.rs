...
pub(super) mod re_export {
    ...
    impl SkeletonModifier3D {
        pub fn get_skeleton(&self,) -> Option < Gd < crate::classes::Skeleton3D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "get_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_active(&mut self, active: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "set_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_active(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "is_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_influence(&mut self, influence: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "set_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_influence(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "get_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_SkeletonModifier3D {
        ($Class: ident) => {
