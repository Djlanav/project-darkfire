...
pub(super) mod re_export {
    ...
    impl EditorImportPlugin {
        pub(crate) fn append_import_external_resource_full(&mut self, path: CowArg < GString >, custom_options: RefArg < Dictionary >, custom_importer: CowArg < GString >, generator_parameters: RefArg < Variant >,) -> crate::global::Error {
            type CallSig < 'a0, 'a1, 'a2, 'a3, > = (crate::global::Error, CowArg < 'a0, GString >, RefArg < 'a1, Dictionary >, CowArg < 'a2, GString >, RefArg < 'a3, Variant >);
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorImportPlugin", "append_import_external_resource", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorImportPlugin {
        ($Class: ident) => {
