...
pub(super) mod re_export {
    ...
    impl EditorDebuggerPlugin {
        pub fn get_session(&mut self, id: i32,) -> Option < Gd < crate::classes::EditorDebuggerSession > > {
            type CallSig = (Option < Gd < crate::classes::EditorDebuggerSession > >, i32);
            let args = (id,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(2usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerPlugin", "get_session", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sessions(&mut self,) -> VariantArray {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorDebuggerPlugin", "get_sessions", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorDebuggerPlugin {
        ($Class: ident) => {
