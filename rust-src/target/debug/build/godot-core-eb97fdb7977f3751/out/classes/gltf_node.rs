...
pub(super) mod re_export {
    ...
    impl GltfNode {
        pub fn get_original_name(&mut self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_original_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_original_name(&mut self, original_name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_original_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_parent(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_parent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_parent(&mut self, parent: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_parent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_height(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height(&mut self, height: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_xform(&mut self,) -> Transform3D {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_xform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_xform(&mut self, xform: Transform3D,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_xform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mesh(&mut self, mesh: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_camera(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_camera", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_camera(&mut self, camera: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_camera", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skin(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skin(&mut self, skin: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skeleton(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skeleton(&mut self, skeleton: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_position(&mut self,) -> Vector3 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_position(&mut self, position: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rotation(&mut self,) -> Quaternion {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rotation(&mut self, rotation: Quaternion,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scale(&mut self,) -> Vector3 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_scale(&mut self, scale: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_children(&mut self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_children", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_children(&mut self, children: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_children", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_light(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_light", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_light(&mut self, light: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_light", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_additional_data(&mut self, extension_name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "get_additional_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_additional_data(&mut self, extension_name: impl AsArg < StringName >, additional_data: &Variant,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GltfNode", "set_additional_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_GltfNode {
        ($Class: ident) => {
