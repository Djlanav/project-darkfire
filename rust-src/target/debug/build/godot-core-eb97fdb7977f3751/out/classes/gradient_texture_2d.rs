...
pub(super) mod re_export {
    ...
    impl GradientTexture2D {
        pub fn set_gradient(&mut self, gradient: impl AsObjectArg < crate::classes::Gradient >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_gradient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_gradient(&self,) -> Option < Gd < crate::classes::Gradient > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "get_gradient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_width(&mut self, width: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height(&mut self, height: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_hdr(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_use_hdr", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_hdr(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "is_using_hdr", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fill(&mut self, fill: crate::classes::gradient_texture_2d::Fill,) {
            type CallSig = ((), crate::classes::gradient_texture_2d::Fill);
            let args = (fill,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3977usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_fill", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fill(&self,) -> crate::classes::gradient_texture_2d::Fill {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "get_fill", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fill_from(&mut self, fill_from: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_fill_from", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fill_from(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "get_fill_from", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fill_to(&mut self, fill_to: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_fill_to", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fill_to(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "get_fill_to", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_repeat(&mut self, repeat: crate::classes::gradient_texture_2d::Repeat,) {
            type CallSig = ((), crate::classes::gradient_texture_2d::Repeat);
            let args = (repeat,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3983usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "set_repeat", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_repeat(&self,) -> crate::classes::gradient_texture_2d::Repeat {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "GradientTexture2D", "get_repeat", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_GradientTexture2D {
        ($Class: ident) => {
