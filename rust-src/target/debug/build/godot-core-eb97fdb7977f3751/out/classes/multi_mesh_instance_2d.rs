...
pub(super) mod re_export {
    ...
    impl MultiMeshInstance2D {
        pub fn set_multimesh(&mut self, multimesh: impl AsObjectArg < crate::classes::MultiMesh >,) {
            type CallSig = ((), ObjectArg < crate::classes::MultiMesh >);
            let args = (multimesh.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5186usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiMeshInstance2D", "set_multimesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_multimesh(&self,) -> Option < Gd < crate::classes::MultiMesh > > {
            type CallSig = (Option < Gd < crate::classes::MultiMesh > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5187usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiMeshInstance2D", "get_multimesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiMeshInstance2D", "set_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiMeshInstance2D", "get_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_MultiMeshInstance2D {
        ($Class: ident) => {
