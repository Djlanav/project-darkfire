...
pub(super) mod re_export {
    ...
    impl LightmapGiData {
        pub fn set_lightmap_textures(&mut self, light_textures: &Array < Gd < crate::classes::TextureLayered > >,) {
            type CallSig < 'a0, > = ((), RefArg < 'a0, Array < Gd < crate::classes::TextureLayered > > >);
            let args = (RefArg::new(light_textures),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4819usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "set_lightmap_textures", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_lightmap_textures(&self,) -> Array < Gd < crate::classes::TextureLayered > > {
            type CallSig = (Array < Gd < crate::classes::TextureLayered > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4820usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "get_lightmap_textures", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_uses_spherical_harmonics(&mut self, uses_spherical_harmonics: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "set_uses_spherical_harmonics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_spherical_harmonics(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "is_using_spherical_harmonics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_user(&mut self, path: impl AsArg < NodePath >, uv_scale: Rect2, slice_index: i32, sub_instance: i32,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, NodePath >, Rect2, i32, i32);
            let args = (path.into_arg(), uv_scale, slice_index, sub_instance,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4823usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "add_user", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_user_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "get_user_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_user_path(&self, user_idx: i32,) -> NodePath {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "get_user_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_users(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "clear_users", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_light_texture(&mut self, light_texture: impl AsObjectArg < crate::classes::TextureLayered >,) {
            type CallSig = ((), ObjectArg < crate::classes::TextureLayered >);
            let args = (light_texture.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4827usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "set_light_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_light_texture(&self,) -> Option < Gd < crate::classes::TextureLayered > > {
            type CallSig = (Option < Gd < crate::classes::TextureLayered > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4828usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "LightmapGiData", "get_light_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_LightmapGiData {
        ($Class: ident) => {
