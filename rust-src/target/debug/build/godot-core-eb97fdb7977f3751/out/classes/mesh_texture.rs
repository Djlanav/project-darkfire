...
pub(super) mod re_export {
    ...
    impl MeshTexture {
        pub fn set_mesh(&mut self, mesh: impl AsObjectArg < crate::classes::Mesh >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "set_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh(&self,) -> Option < Gd < crate::classes::Mesh > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "get_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_image_size(&mut self, size: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "set_image_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_image_size(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "get_image_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_base_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "set_base_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_base_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MeshTexture", "get_base_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_MeshTexture {
        ($Class: ident) => {
