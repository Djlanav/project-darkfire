...
pub(super) mod re_export {
    ...
    impl ImmediateMesh {
        pub(crate) fn surface_begin_full(&mut self, primitive: crate::classes::mesh::PrimitiveType, material: ObjectArg < crate::classes::Material >,) {
            type CallSig = ((), crate::classes::mesh::PrimitiveType, ObjectArg < crate::classes::Material >);
            let args = (primitive, material,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4194usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_begin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn surface_set_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_set_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_set_normal(&mut self, normal: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_set_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_set_tangent(&mut self, tangent: Plane,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_set_tangent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_set_uv(&mut self, uv: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_set_uv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_set_uv2(&mut self, uv2: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_set_uv2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_add_vertex(&mut self, vertex: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_add_vertex", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_add_vertex_2d(&mut self, vertex: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_add_vertex_2d", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn surface_end(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "surface_end", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_surfaces(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImmediateMesh", "clear_surfaces", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ImmediateMesh {
        ($Class: ident) => {
