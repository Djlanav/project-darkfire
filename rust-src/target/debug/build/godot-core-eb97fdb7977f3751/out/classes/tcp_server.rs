...
pub(super) mod re_export {
    ...
    impl TcpServer {
        pub(crate) fn listen_full(&mut self, port: u16, bind_address: CowArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "listen", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn is_connection_available(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "is_connection_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_listening(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "is_listening", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "get_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn take_connection(&mut self,) -> Option < Gd < crate::classes::StreamPeerTcp > > {
            type CallSig = (Option < Gd < crate::classes::StreamPeerTcp > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8219usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "take_connection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn stop(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TcpServer", "stop", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TcpServer {
        ($Class: ident) => {
