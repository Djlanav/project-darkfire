...
pub(super) mod re_export {
    ...
    impl TorusMesh {
        pub fn set_inner_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "set_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inner_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "get_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_outer_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "set_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_outer_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "get_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rings(&mut self, rings: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "set_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rings(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "get_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ring_segments(&mut self, rings: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "set_ring_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ring_segments(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TorusMesh", "get_ring_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TorusMesh {
        ($Class: ident) => {
