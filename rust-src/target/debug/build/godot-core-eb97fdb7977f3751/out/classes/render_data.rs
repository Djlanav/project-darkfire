...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`RenderData`][crate::classes::RenderData].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `RenderData` methods](https://docs.godotengine.org/en/stable/classes/class_renderdata.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IRenderData: crate::obj::GodotClass < Base = RenderData > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl RenderData {
        pub fn get_render_scene_buffers(&self,) -> Option < Gd < crate::classes::RenderSceneBuffers > > {
            type CallSig = (Option < Gd < crate::classes::RenderSceneBuffers > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6966usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderData", "get_render_scene_buffers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_render_scene_data(&self,) -> Option < Gd < crate::classes::RenderSceneData > > {
            type CallSig = (Option < Gd < crate::classes::RenderSceneData > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6967usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderData", "get_render_scene_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_environment(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderData", "get_environment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_camera_attributes(&self,) -> Rid {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderData", "get_camera_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`RenderData`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_RenderData {
        ($Class: ident) => {
