...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`Shape3D`][crate::classes::Shape3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `Shape3D` methods](https://docs.godotengine.org/en/stable/classes/class_shape3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IShape3D: crate::obj::GodotClass < Base = Shape3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl Shape3D {
        pub fn set_custom_solver_bias(&mut self, bias: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shape3D", "set_custom_solver_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_custom_solver_bias(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shape3D", "get_custom_solver_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_margin(&mut self, margin: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shape3D", "set_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shape3D", "get_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_debug_mesh(&mut self,) -> Option < Gd < crate::classes::ArrayMesh > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Shape3D", "get_debug_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`Shape3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_Shape3D {
        ($Class: ident) => {
