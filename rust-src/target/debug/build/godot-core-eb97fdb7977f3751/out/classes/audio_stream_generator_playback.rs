...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`AudioStreamGeneratorPlayback`][crate::classes::AudioStreamGeneratorPlayback].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `AudioStreamGeneratorPlayback` methods](https://docs.godotengine.org/en/stable/classes/class_audiostreamgeneratorplayback.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IAudioStreamGeneratorPlayback: crate::obj::GodotClass < Base = AudioStreamGeneratorPlayback > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
        ...
        unsafe fn mix_resampled(&mut self, dst_buffer: * mut AudioFrame, frame_count: i32,) -> i32;
    ...
    impl AudioStreamGeneratorPlayback {
        pub fn push_frame(&mut self, frame: Vector2,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "push_frame", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn can_push_buffer(&self, amount: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "can_push_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn push_buffer(&mut self, frames: &PackedVector2Array,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "push_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frames_available(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "get_frames_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skips(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "get_skips", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_buffer(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStreamGeneratorPlayback", "clear_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`AudioStreamGeneratorPlayback`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_AudioStreamGeneratorPlayback {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::AudioStreamGeneratorPlayback > for $Class {
