...
pub(super) mod re_export {
    ...
    impl PackedScene {
        pub fn pack(&mut self, path: impl AsObjectArg < crate::classes::Node >,) -> crate::global::Error {
            type CallSig = (crate::global::Error, ObjectArg < crate::classes::Node >);
            let args = (path.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5867usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PackedScene", "pack", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn instantiate_full(&self, edit_state: crate::classes::packed_scene::GenEditState,) -> Option < Gd < crate::classes::Node > > {
            type CallSig = (Option < Gd < crate::classes::Node > >, crate::classes::packed_scene::GenEditState);
            let args = (edit_state,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5868usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PackedScene", "instantiate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn can_instantiate(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PackedScene", "can_instantiate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_state(&self,) -> Option < Gd < crate::classes::SceneState > > {
            type CallSig = (Option < Gd < crate::classes::SceneState > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5870usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PackedScene", "get_state", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PackedScene {
        ($Class: ident) => {
