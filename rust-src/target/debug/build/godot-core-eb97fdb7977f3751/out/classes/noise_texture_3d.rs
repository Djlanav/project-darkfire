...
pub(super) mod re_export {
    ...
    impl NoiseTexture3D {
        pub fn set_width(&mut self, width: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height(&mut self, height: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_depth(&mut self, depth: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_invert(&mut self, invert: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_invert", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_invert(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_invert", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_seamless(&mut self, seamless: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_seamless", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_seamless(&mut self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_seamless", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_seamless_blend_skirt(&mut self, seamless_blend_skirt: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_seamless_blend_skirt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_seamless_blend_skirt(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_seamless_blend_skirt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_normalize(&mut self, normalize: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_normalize", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_normalized(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "is_normalized", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_color_ramp(&mut self, gradient: impl AsObjectArg < crate::classes::Gradient >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_color_ramp", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color_ramp(&self,) -> Option < Gd < crate::classes::Gradient > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_color_ramp", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_noise(&mut self, noise: impl AsObjectArg < crate::classes::Noise >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_noise", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_noise(&mut self,) -> Option < Gd < crate::classes::Noise > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_noise", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_NoiseTexture3D {
        ($Class: ident) => {
