...
pub(super) mod re_export {
    ...
    impl ProgressBar {
        pub fn set_fill_mode(&mut self, mode: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "set_fill_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fill_mode(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "get_fill_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_show_percentage(&mut self, visible: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "set_show_percentage", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_percentage_shown(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "is_percentage_shown", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_indeterminate(&mut self, indeterminate: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "set_indeterminate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_indeterminate(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "is_indeterminate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_editor_preview_indeterminate(&mut self, preview_indeterminate: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "set_editor_preview_indeterminate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_editor_preview_indeterminate_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ProgressBar", "is_editor_preview_indeterminate_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ProgressBar {
        ($Class: ident) => {
