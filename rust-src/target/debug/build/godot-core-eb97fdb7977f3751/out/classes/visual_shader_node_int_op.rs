...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeIntOp {
        pub fn set_operator(&mut self, op: crate::classes::visual_shader_node_int_op::Operator,) {
            type CallSig = ((), crate::classes::visual_shader_node_int_op::Operator);
            let args = (op,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10085usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntOp", "set_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_operator(&self,) -> crate::classes::visual_shader_node_int_op::Operator {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntOp", "get_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeIntOp {
        ($Class: ident) => {
