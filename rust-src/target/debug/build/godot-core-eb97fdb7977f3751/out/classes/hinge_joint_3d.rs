...
pub(super) mod re_export {
    ...
    impl HingeJoint3D {
        pub fn set_param(&mut self, param: crate::classes::hinge_joint_3d::Param, value: f32,) {
            type CallSig = ((), crate::classes::hinge_joint_3d::Param, f32);
            let args = (param, value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4098usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "HingeJoint3D", "set_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_param(&self, param: crate::classes::hinge_joint_3d::Param,) -> f32 {
            type CallSig = (f32, crate::classes::hinge_joint_3d::Param);
            let args = (param,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4099usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "HingeJoint3D", "get_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_flag(&mut self, flag: crate::classes::hinge_joint_3d::Flag, enabled: bool,) {
            type CallSig = ((), crate::classes::hinge_joint_3d::Flag, bool);
            let args = (flag, enabled,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4100usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "HingeJoint3D", "set_flag", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_flag(&self, flag: crate::classes::hinge_joint_3d::Flag,) -> bool {
            type CallSig = (bool, crate::classes::hinge_joint_3d::Flag);
            let args = (flag,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4101usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "HingeJoint3D", "get_flag", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_HingeJoint3D {
        ($Class: ident) => {
