...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeInput {
        pub fn set_input_name(&mut self, name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeInput", "set_input_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeInput", "get_input_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_input_real_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeInput", "get_input_real_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeInput {
        ($Class: ident) => {
