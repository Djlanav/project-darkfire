...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeFloatFunc {
        pub fn set_function(&mut self, func: crate::classes::visual_shader_node_float_func::Function,) {
            type CallSig = ((), crate::classes::visual_shader_node_float_func::Function);
            let args = (func,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10029usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatFunc", "set_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_function(&self,) -> crate::classes::visual_shader_node_float_func::Function {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatFunc", "get_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeFloatFunc {
        ($Class: ident) => {
