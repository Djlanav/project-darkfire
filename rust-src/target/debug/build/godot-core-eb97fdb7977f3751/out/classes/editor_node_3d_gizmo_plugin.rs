...
pub(super) mod re_export {
    ...
    impl EditorNode3DGizmoPlugin {
        pub(crate) fn create_material_full(&mut self, name: CowArg < GString >, color: Color, billboard: bool, on_top: bool, use_vertex_color: bool,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, GString >, Color, bool, bool, bool);
            let args = (name, color, billboard, on_top, use_vertex_color,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(168usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorNode3DGizmoPlugin", "create_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_icon_material_full(&mut self, name: CowArg < GString >, texture: ObjectArg < crate::classes::Texture2D >, on_top: bool, color: Color,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, GString >, ObjectArg < crate::classes::Texture2D >, bool, Color);
            let args = (name, texture, on_top, color,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(169usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorNode3DGizmoPlugin", "create_icon_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_handle_material_full(&mut self, name: CowArg < GString >, billboard: bool, texture: ObjectArg < crate::classes::Texture2D >,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, GString >, bool, ObjectArg < crate::classes::Texture2D >);
            let args = (name, billboard, texture,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(170usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorNode3DGizmoPlugin", "create_handle_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn add_material(&mut self, name: impl AsArg < GString >, material: impl AsObjectArg < crate::classes::StandardMaterial3D >,) {
            type CallSig < 'a0, > = ((), CowArg < 'a0, GString >, ObjectArg < crate::classes::StandardMaterial3D >);
            let args = (name.into_arg(), material.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(171usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorNode3DGizmoPlugin", "add_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_material_full(&mut self, name: CowArg < GString >, gizmo: ObjectArg < crate::classes::EditorNode3DGizmo >,) -> Option < Gd < crate::classes::StandardMaterial3D > > {
            type CallSig < 'a0, > = (Option < Gd < crate::classes::StandardMaterial3D > >, CowArg < 'a0, GString >, ObjectArg < crate::classes::EditorNode3DGizmo >);
            let args = (name, gizmo,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(172usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorNode3DGizmoPlugin", "get_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorNode3DGizmoPlugin {
        ($Class: ident) => {
