...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`AudioStreamPlaybackPlaylist`][crate::classes::AudioStreamPlaybackPlaylist].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `AudioStreamPlaybackPlaylist` methods](https://docs.godotengine.org/en/stable/classes/class_audiostreamplaybackplaylist.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IAudioStreamPlaybackPlaylist: crate::obj::GodotClass < Base = AudioStreamPlaybackPlaylist > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`AudioStreamPlaybackPlaylist`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_AudioStreamPlaybackPlaylist {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::AudioStreamPlaybackPlaylist > for $Class {
