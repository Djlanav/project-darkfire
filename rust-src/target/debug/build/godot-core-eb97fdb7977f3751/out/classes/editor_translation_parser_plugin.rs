...
pub(super) mod re_export {
    ...
    pub trait IEditorTranslationParserPlugin: crate::obj::GodotClass < Base = EditorTranslationParserPlugin > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        fn parse_file(&mut self, path: GString, msgids: Array < GString >, msgids_context_plural: Array < VariantArray >,) {
            unimplemented !()
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorTranslationParserPlugin {
        ($Class: ident) => {
