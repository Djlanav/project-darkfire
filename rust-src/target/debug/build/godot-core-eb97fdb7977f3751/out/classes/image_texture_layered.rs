...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`ImageTextureLayered`][crate::classes::ImageTextureLayered].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `ImageTextureLayered` methods](https://docs.godotengine.org/en/stable/classes/class_imagetexturelayered.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IImageTextureLayered: crate::obj::GodotClass < Base = ImageTextureLayered > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl ImageTextureLayered {
        pub fn create_from_images(&mut self, images: &Array < Gd < crate::classes::Image > >,) -> crate::global::Error {
            type CallSig < 'a0, > = (crate::global::Error, RefArg < 'a0, Array < Gd < crate::classes::Image > > >);
            let args = (RefArg::new(images),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4192usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImageTextureLayered", "create_from_images", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_layer(&mut self, image: impl AsObjectArg < crate::classes::Image >, layer: i32,) {
            type CallSig = ((), ObjectArg < crate::classes::Image >, i32);
            let args = (image.as_object_arg(), layer,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4193usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ImageTextureLayered", "update_layer", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ImageTextureLayered`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_ImageTextureLayered {
        ($Class: ident) => {
