...
pub(super) mod re_export {
    ...
    impl VideoStreamPlayback {
        pub(crate) fn mix_audio_full(&mut self, num_frames: i32, buffer: RefArg < PackedFloat32Array >, offset: i32,) -> i32 {
            type CallSig < 'a0, > = (i32, i32, RefArg < 'a0, PackedFloat32Array >, i32);
            let args = (num_frames, buffer, offset,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9778usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayback", "mix_audio", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VideoStreamPlayback {
        ($Class: ident) => {
