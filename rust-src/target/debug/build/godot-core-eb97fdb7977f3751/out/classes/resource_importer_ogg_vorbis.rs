...
pub(super) mod re_export {
    ...
    impl ResourceImporterOggVorbis {
        pub fn load_from_buffer(buffer: &PackedByteArray,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceImporterOggVorbis", "load_from_buffer", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn load_from_file(path: impl AsArg < GString >,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ResourceImporterOggVorbis", "load_from_file", std::ptr::null_mut(), None, args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ResourceImporterOggVorbis {
        ($Class: ident) => {
