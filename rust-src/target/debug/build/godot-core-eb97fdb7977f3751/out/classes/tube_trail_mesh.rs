...
pub(super) mod re_export {
    ...
    impl TubeTrailMesh {
        pub fn set_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_radial_steps(&mut self, radial_steps: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_radial_steps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radial_steps(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_radial_steps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sections(&mut self, sections: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sections(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_length(&mut self, section_length: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_rings(&mut self, section_rings: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_section_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_rings(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_section_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_top(&mut self, cap_top: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_top(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "is_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_bottom(&mut self, cap_bottom: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_bottom(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "is_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_curve(&mut self, curve: impl AsObjectArg < crate::classes::Curve >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_curve(&self,) -> Option < Gd < crate::classes::Curve > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TubeTrailMesh {
        ($Class: ident) => {
