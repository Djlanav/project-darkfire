...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`FileSystemDock`][crate::classes::FileSystemDock].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `FileSystemDock` methods](https://docs.godotengine.org/en/stable/classes/class_filesystemdock.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IFileSystemDock: crate::obj::GodotClass < Base = FileSystemDock > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl FileSystemDock {
        pub fn navigate_to_path(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "FileSystemDock", "navigate_to_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_resource_tooltip_plugin(&mut self, plugin: impl AsObjectArg < crate::classes::EditorResourceTooltipPlugin >,) {
            type CallSig = ((), ObjectArg < crate::classes::EditorResourceTooltipPlugin >);
            let args = (plugin.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(321usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "FileSystemDock", "add_resource_tooltip_plugin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_resource_tooltip_plugin(&mut self, plugin: impl AsObjectArg < crate::classes::EditorResourceTooltipPlugin >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "FileSystemDock", "remove_resource_tooltip_plugin", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`FileSystemDock`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_FileSystemDock {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::FileSystemDock > for $Class {
