...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`Occluder3D`][crate::classes::Occluder3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `Occluder3D` methods](https://docs.godotengine.org/en/stable/classes/class_occluder3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IOccluder3D: crate::obj::GodotClass < Base = Occluder3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl Occluder3D {
        pub fn get_vertices(&self,) -> PackedVector3Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Occluder3D", "get_vertices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_indices(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Occluder3D", "get_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`Occluder3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_Occluder3D {
        ($Class: ident) => {
