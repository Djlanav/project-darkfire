...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeTexture {
        pub fn set_source(&mut self, value: crate::classes::visual_shader_node_texture::Source,) {
            type CallSig = ((), crate::classes::visual_shader_node_texture::Source);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10138usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "set_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_source(&self,) -> crate::classes::visual_shader_node_texture::Source {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "get_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture(&mut self, value: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "set_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "get_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_type(&mut self, value: crate::classes::visual_shader_node_texture::TextureType,) {
            type CallSig = ((), crate::classes::visual_shader_node_texture::TextureType);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10142usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "set_texture_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_type(&self,) -> crate::classes::visual_shader_node_texture::TextureType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeTexture", "get_texture_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeTexture {
        ($Class: ident) => {
