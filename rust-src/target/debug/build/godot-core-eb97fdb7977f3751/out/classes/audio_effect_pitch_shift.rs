...
pub(super) mod re_export {
    ...
    impl AudioEffectPitchShift {
        pub fn set_pitch_scale(&mut self, rate: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_pitch_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pitch_scale(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_pitch_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_oversampling(&mut self, amount: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_oversampling", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_oversampling(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_oversampling", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fft_size(&mut self, size: crate::classes::audio_effect_pitch_shift::FftSize,) {
            type CallSig = ((), crate::classes::audio_effect_pitch_shift::FftSize);
            let args = (size,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(753usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_fft_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fft_size(&self,) -> crate::classes::audio_effect_pitch_shift::FftSize {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_fft_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_AudioEffectPitchShift {
        ($Class: ident) => {
