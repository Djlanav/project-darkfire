...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`EditorExportPlatform`][crate::classes::EditorExportPlatform].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `EditorExportPlatform` methods](https://docs.godotengine.org/en/stable/classes/class_editorexportplatform.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IEditorExportPlatform: crate::obj::GodotClass < Base = EditorExportPlatform > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl EditorExportPlatform {
        pub fn get_os_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorExportPlatform", "get_os_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`EditorExportPlatform`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_EditorExportPlatform {
        ($Class: ident) => {
