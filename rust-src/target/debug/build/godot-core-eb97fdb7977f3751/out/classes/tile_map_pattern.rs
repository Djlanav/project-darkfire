...
pub(super) mod re_export {
    ...
    impl TileMapPattern {
        pub(crate) fn set_cell_full(&mut self, coords: Vector2i, source_id: i32, atlas_coords: Vector2i, alternative_tile: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "set_cell", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn has_cell(&self, coords: Vector2i,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "has_cell", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_cell(&mut self, coords: Vector2i, update_size: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "remove_cell", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cell_source_id(&self, coords: Vector2i,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "get_cell_source_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cell_atlas_coords(&self, coords: Vector2i,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "get_cell_atlas_coords", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cell_alternative_tile(&self, coords: Vector2i,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "get_cell_alternative_tile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_used_cells(&self,) -> Array < Vector2i > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "get_used_cells", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_size(&mut self, size: Vector2i,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_empty(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "TileMapPattern", "is_empty", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_TileMapPattern {
        ($Class: ident) => {
