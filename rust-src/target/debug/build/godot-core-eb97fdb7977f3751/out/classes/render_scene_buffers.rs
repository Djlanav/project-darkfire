...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`RenderSceneBuffers`][crate::classes::RenderSceneBuffers].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `RenderSceneBuffers` methods](https://docs.godotengine.org/en/stable/classes/class_renderscenebuffers.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IRenderSceneBuffers: crate::obj::GodotClass < Base = RenderSceneBuffers > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl RenderSceneBuffers {
        pub fn configure(&mut self, config: impl AsObjectArg < crate::classes::RenderSceneBuffersConfiguration >,) {
            type CallSig = ((), ObjectArg < crate::classes::RenderSceneBuffersConfiguration >);
            let args = (config.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6970usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "RenderSceneBuffers", "configure", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`RenderSceneBuffers`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_RenderSceneBuffers {
        ($Class: ident) => {
