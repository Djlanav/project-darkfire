...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeIntParameter {
        pub fn set_hint(&mut self, hint: crate::classes::visual_shader_node_int_parameter::Hint,) {
            type CallSig = ((), crate::classes::visual_shader_node_int_parameter::Hint);
            let args = (hint,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10087usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_hint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_hint(&self,) -> crate::classes::visual_shader_node_int_parameter::Hint {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "get_hint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_min(&mut self, value: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "get_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max(&mut self, value: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "get_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_step(&mut self, value: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_step(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "get_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_default_value_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_default_value_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_default_value_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "is_default_value_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_default_value(&mut self, value: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "set_default_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_default_value(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeIntParameter", "get_default_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeIntParameter {
        ($Class: ident) => {
