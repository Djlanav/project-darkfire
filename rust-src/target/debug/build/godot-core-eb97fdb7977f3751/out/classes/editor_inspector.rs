...
pub(super) mod re_export {
    ...
    impl EditorInspector {
        pub fn get_selected_path(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorInspector", "get_selected_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edited_object(&mut self,) -> Option < Gd < crate::classes::Object > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorInspector", "get_edited_object", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorInspector {
        ($Class: ident) => {
