...
pub(super) mod re_export {
    ...
    impl PointLight2D {
        pub fn set_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "set_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "get_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_offset(&mut self, texture_offset: Vector2,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "set_texture_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_offset(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "get_texture_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_scale(&mut self, texture_scale: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "set_texture_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_scale(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "PointLight2D", "get_texture_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_PointLight2D {
        ($Class: ident) => {
