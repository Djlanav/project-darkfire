...
pub(super) mod re_export {
    ...
    impl VoxelGi {
        pub fn set_probe_data(&mut self, data: impl AsObjectArg < crate::classes::VoxelGiData >,) {
            type CallSig = ((), ObjectArg < crate::classes::VoxelGiData >);
            let args = (data.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10210usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "set_probe_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_probe_data(&self,) -> Option < Gd < crate::classes::VoxelGiData > > {
            type CallSig = (Option < Gd < crate::classes::VoxelGiData > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10211usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "get_probe_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdiv(&mut self, subdiv: crate::classes::voxel_gi::Subdiv,) {
            type CallSig = ((), crate::classes::voxel_gi::Subdiv);
            let args = (subdiv,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10212usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "set_subdiv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdiv(&self,) -> crate::classes::voxel_gi::Subdiv {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "get_subdiv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_camera_attributes(&mut self, camera_attributes: impl AsObjectArg < crate::classes::CameraAttributes >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "set_camera_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_camera_attributes(&self,) -> Option < Gd < crate::classes::CameraAttributes > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "get_camera_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn bake_full(&mut self, from_node: ObjectArg < crate::classes::Node >, create_visual_debug: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "bake", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn debug_bake(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VoxelGi", "debug_bake", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VoxelGi {
        ($Class: ident) => {
