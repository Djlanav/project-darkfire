...
pub(super) mod re_export {
    ...
    impl EditorScenePostImportPlugin {
        pub fn get_option_value(&self, name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorScenePostImportPlugin", "get_option_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_import_option(&mut self, name: impl AsArg < GString >, value: &Variant,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorScenePostImportPlugin", "add_import_option", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_import_option_advanced_full(&mut self, type_: VariantType, name: CowArg < GString >, default_value: RefArg < Variant >, hint: crate::global::PropertyHint, hint_string: CowArg < GString >, usage_flags: i32,) {
            type CallSig < 'a0, 'a1, 'a2, > = ((), VariantType, CowArg < 'a0, GString >, RefArg < 'a1, Variant >, crate::global::PropertyHint, CowArg < 'a2, GString >, i32);
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "EditorScenePostImportPlugin", "add_import_option_advanced", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_EditorScenePostImportPlugin {
        ($Class: ident) => {
