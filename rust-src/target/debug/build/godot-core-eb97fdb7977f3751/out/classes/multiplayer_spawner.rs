...
pub(super) mod re_export {
    ...
    impl MultiplayerSpawner {
        pub fn add_spawnable_scene(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "add_spawnable_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_spawnable_scene_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "get_spawnable_scene_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_spawnable_scene(&self, index: i32,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "get_spawnable_scene", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_spawnable_scenes(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "clear_spawnable_scenes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn spawn_full(&mut self, data: RefArg < Variant >,) -> Option < Gd < crate::classes::Node > > {
            type CallSig < 'a0, > = (Option < Gd < crate::classes::Node > >, RefArg < 'a0, Variant >);
            let args = (data,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5227usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "spawn", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_spawn_path(&self,) -> NodePath {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "get_spawn_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_spawn_path(&mut self, path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "set_spawn_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_spawn_limit(&self,) -> u32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "get_spawn_limit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_spawn_limit(&mut self, limit: u32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "set_spawn_limit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_spawn_function(&self,) -> Callable {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "get_spawn_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_spawn_function(&mut self, spawn_function: &Callable,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "MultiplayerSpawner", "set_spawn_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_MultiplayerSpawner {
        ($Class: ident) => {
