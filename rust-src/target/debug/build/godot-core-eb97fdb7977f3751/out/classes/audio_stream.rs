...
pub(super) mod re_export {
    ...
    impl AudioStream {
        pub fn get_length(&self,) -> f64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStream", "get_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_monophonic(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStream", "is_monophonic", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn instantiate_playback(&mut self,) -> Option < Gd < crate::classes::AudioStreamPlayback > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStream", "instantiate_playback", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn can_be_sampled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStream", "can_be_sampled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_meta_stream(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "AudioStream", "is_meta_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_AudioStream {
        ($Class: ident) => {
