...
pub(super) mod re_export {
    ...
    impl InputEventShortcut {
        pub fn set_shortcut(&mut self, shortcut: impl AsObjectArg < crate::classes::Shortcut >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventShortcut", "set_shortcut", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shortcut(&mut self,) -> Option < Gd < crate::classes::Shortcut > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "InputEventShortcut", "get_shortcut", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_InputEventShortcut {
        ($Class: ident) => {
