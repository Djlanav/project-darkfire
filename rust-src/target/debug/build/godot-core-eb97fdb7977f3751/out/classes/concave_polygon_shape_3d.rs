...
pub(super) mod re_export {
    ...
    impl ConcavePolygonShape3D {
        pub fn set_faces(&mut self, faces: &PackedVector3Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "set_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_faces(&self,) -> PackedVector3Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "get_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_backface_collision_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "set_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_backface_collision_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "is_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_ConcavePolygonShape3D {
        ($Class: ident) => {
