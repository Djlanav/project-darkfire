...
pub(super) mod re_export {
    ...
    impl VideoStreamPlayer {
        pub fn set_stream(&mut self, stream: impl AsObjectArg < crate::classes::VideoStream >,) {
            type CallSig = ((), ObjectArg < crate::classes::VideoStream >);
            let args = (stream.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9779usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_stream(&self,) -> Option < Gd < crate::classes::VideoStream > > {
            type CallSig = (Option < Gd < crate::classes::VideoStream > >,);
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(9780usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn play(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "play", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn stop(&mut self,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "stop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_playing(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "is_playing", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_paused(&mut self, paused: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_paused", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_paused(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "is_paused", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_loop(&mut self, loop_: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_loop(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "has_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_volume(&mut self, volume: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_volume", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_volume(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_volume", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_volume_db(&mut self, db: f32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_volume_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_volume_db(&self,) -> f32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_volume_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_audio_track(&mut self, track: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_audio_track", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_audio_track(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_audio_track", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_stream_name(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_stream_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_stream_length(&self,) -> f64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_stream_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_stream_position(&mut self, position: f64,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_stream_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_stream_position(&self,) -> f64 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_stream_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_autoplay(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_autoplay", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_autoplay(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "has_autoplay", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_expand(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_expand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_expand(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "has_expand", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffering_msec(&mut self, msec: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_buffering_msec", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffering_msec(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_buffering_msec", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bus(&mut self, bus: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "set_bus", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bus(&self,) -> StringName {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_bus", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_video_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VideoStreamPlayer", "get_video_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VideoStreamPlayer {
        ($Class: ident) => {
