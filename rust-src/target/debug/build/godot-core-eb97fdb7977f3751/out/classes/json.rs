...
pub(super) mod re_export {
    ...
    impl Json {
        pub(crate) fn stringify_full(data: RefArg < Variant >, indent: CowArg < GString >, sort_keys: bool, full_precision: bool,) -> GString {
            type CallSig < 'a0, 'a1, > = (GString, RefArg < 'a0, Variant >, CowArg < 'a1, GString >, bool, bool);
            let args = (data, indent, sort_keys, full_precision,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4532usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "stringify", std::ptr::null_mut(), None, args,)
            }
        }
        ...
        pub fn parse_string(json_string: impl AsArg < GString >,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "parse_string", std::ptr::null_mut(), None, args,)
            }
        }
        pub(crate) fn parse_full(&mut self, json_text: CowArg < GString >, keep_text: bool,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "parse", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_data(&self,) -> Variant {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "get_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_data(&mut self, data: &Variant,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "set_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_parsed_text(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "get_parsed_text", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_error_line(&self,) -> i32 {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "get_error_line", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_error_message(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "Json", "get_error_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_Json {
        ($Class: ident) => {
