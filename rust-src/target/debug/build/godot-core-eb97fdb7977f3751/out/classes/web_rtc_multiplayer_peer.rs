...
pub(super) mod re_export {
    ...
    impl WebRtcMultiplayerPeer {
        pub(crate) fn create_server_full(&mut self, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            type CallSig < 'a0, > = (crate::global::Error, RefArg < 'a0, VariantArray >);
            let args = (channels_config,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10256usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "create_server", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_client_full(&mut self, peer_id: i32, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            type CallSig < 'a0, > = (crate::global::Error, i32, RefArg < 'a0, VariantArray >);
            let args = (peer_id, channels_config,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10257usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "create_client", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_mesh_full(&mut self, peer_id: i32, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "create_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn add_peer_full(&mut self, peer: ObjectArg < crate::classes::WebRtcPeerConnection >, peer_id: i32, unreliable_lifetime: i32,) -> crate::global::Error {
            type CallSig = (crate::global::Error, ObjectArg < crate::classes::WebRtcPeerConnection >, i32, i32);
            let args = (peer, peer_id, unreliable_lifetime,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10259usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "add_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn remove_peer(&mut self, peer_id: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "remove_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_peer(&mut self, peer_id: i32,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "has_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_peer(&mut self, peer_id: i32,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "get_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_peers(&mut self,) -> Dictionary {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "WebRtcMultiplayerPeer", "get_peers", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_WebRtcMultiplayerPeer {
        ($Class: ident) => {
