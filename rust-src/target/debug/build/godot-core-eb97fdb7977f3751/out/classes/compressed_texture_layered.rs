...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`CompressedTextureLayered`][crate::classes::CompressedTextureLayered].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `CompressedTextureLayered` methods](https://docs.godotengine.org/en/stable/classes/class_compressedtexturelayered.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait ICompressedTextureLayered: crate::obj::GodotClass < Base = CompressedTextureLayered > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl CompressedTextureLayered {
        pub fn load(&mut self, path: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CompressedTextureLayered", "load", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_load_path(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "CompressedTextureLayered", "get_load_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`CompressedTextureLayered`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_CompressedTextureLayered {
        ($Class: ident) => {
