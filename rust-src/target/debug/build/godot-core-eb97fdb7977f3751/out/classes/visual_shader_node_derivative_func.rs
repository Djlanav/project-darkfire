...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeDerivativeFunc {
        pub fn set_op_type(&mut self, type_: crate::classes::visual_shader_node_derivative_func::OpType,) {
            type CallSig = ((), crate::classes::visual_shader_node_derivative_func::OpType);
            let args = (type_,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10019usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "set_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_op_type(&self,) -> crate::classes::visual_shader_node_derivative_func::OpType {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "get_op_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_function(&mut self, func: crate::classes::visual_shader_node_derivative_func::Function,) {
            type CallSig = ((), crate::classes::visual_shader_node_derivative_func::Function);
            let args = (func,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10021usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "set_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_function(&self,) -> crate::classes::visual_shader_node_derivative_func::Function {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "get_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_precision(&mut self, precision: crate::classes::visual_shader_node_derivative_func::Precision,) {
            type CallSig = ((), crate::classes::visual_shader_node_derivative_func::Precision);
            let args = (precision,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10023usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "set_precision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_precision(&self,) -> crate::classes::visual_shader_node_derivative_func::Precision {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeDerivativeFunc", "get_precision", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeDerivativeFunc {
        ($Class: ident) => {
