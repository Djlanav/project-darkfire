...
pub(super) mod re_export {
    ...
    #[doc = "Virtual methods for class [`VisualShaderNodeSample3D`][crate::classes::VisualShaderNodeSample3D].\n\nThese methods represent constructors (`init`) or callbacks invoked by the engine.\n\nSee also [Godot docs for `VisualShaderNodeSample3D` methods](https://docs.godotengine.org/en/stable/classes/class_visualshadernodesample3d.html#methods).\n\n"]
    #[allow(unused_variables)]
    #[allow(clippy::unimplemented)]
    pub trait IVisualShaderNodeSample3D: crate::obj::GodotClass < Base = VisualShaderNodeSample3D > + crate::private::You_forgot_the_attribute__godot_api {
        #[doc(hidden)]
    ...
    impl VisualShaderNodeSample3D {
        pub fn set_source(&mut self, value: crate::classes::visual_shader_node_sample_3d::Source,) {
            type CallSig = ((), crate::classes::visual_shader_node_sample_3d::Source);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10130usize);
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeSample3D", "set_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_source(&self,) -> crate::classes::visual_shader_node_sample_3d::Source {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeSample3D", "get_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeSample3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeSample3D {
        ($Class: ident) => {
