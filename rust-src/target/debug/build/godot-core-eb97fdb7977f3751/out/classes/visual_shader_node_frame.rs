...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeFrame {
        pub fn set_title(&mut self, title: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "set_title", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_title(&self,) -> GString {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "get_title", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tint_color_enabled(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "set_tint_color_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_tint_color_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "is_tint_color_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tint_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "set_tint_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tint_color(&self,) -> Color {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "get_tint_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_autoshrink_enabled(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "set_autoshrink_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_autoshrink_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "is_autoshrink_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_attached_node(&mut self, node: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "add_attached_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_attached_node(&mut self, node: i32,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "remove_attached_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_attached_nodes(&mut self, attached_nodes: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "set_attached_nodes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attached_nodes(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                < CallSig as PtrcallSignatureTuple > ::out_class_ptrcall(method_bind, "VisualShaderNodeFrame", "get_attached_nodes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !unsafe_inherits_transitive_VisualShaderNodeFrame {
        ($Class: ident) => {
