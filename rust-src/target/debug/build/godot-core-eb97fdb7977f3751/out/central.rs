...
impl std::fmt::Debug for VariantDispatch {
    fn fmt(&self, f: &mut std::fmt::Formatter < '_ >) -> std::fmt::Result {
        match self {
            Self::Nil => write !(f, "null"), Self::Bool(v) => write !(f, "{v:?}"), Self::Int(v) => write !(f, "{v:?}"), Self::Float(v) => write !(f, "{v:?}"), Self::String(v) => write !(f, "{v:?}"), Self::Vector2(v) => write !(f, "{v:?}"), Self::Vector2i(v) => write !(f, "{v:?}"), Self::Rect2(v) => write !(f, "{v:?}"), Self::Rect2i(v) => write !(f, "{v:?}"), Self::Vector3(v) => write !(f, "{v:?}"), Self::Vector3i(v) => write !(f, "{v:?}"), Self::Transform2D(v) => write !(f, "{v:?}"), Self::Vector4(v) => write !(f, "{v:?}"), Self::Vector4i(v) => write !(f, "{v:?}"), Self::Plane(v) => write !(f, "{v:?}"), Self::Quaternion(v) => write !(f, "{v:?}"), Self::Aabb(v) => write !(f, "{v:?}"), Self::Basis(v) => write !(f, "{v:?}"), Self::Transform3D(v) => write !(f, "{v:?}"), Self::Projection(v) => write !(f, "{v:?}"), Self::Color(v) => write !(f, "{v:?}"), Self::StringName(v) => write !(f, "{v:?}"), Self::NodePath(v) => write !(f, "{v:?}"), Self::Rid(v) => write !(f, "{v:?}"), Self::Object(v) => write !(f, "{v:?}"), Self::Callable(v) => write !(f, "{v:?}"), Self::Signal(v) => write !(f, "{v:?}"), Self::Dictionary(v) => write !(f, "{v:?}"), Self::Array(v) => write !(f, "{v:?}"), Self::PackedByteArray(v) => write !(f, "{v:?}"), Self::PackedInt32Array(v) => write !(f, "{v:?}"), Self::PackedInt64Array(v) => write !(f, "{v:?}"), Self::PackedFloat32Array(v) => write !(f, "{v:?}"), Self::PackedFloat64Array(v) => write !(f, "{v:?}"), Self::PackedStringArray(v) => write !(f, "{v:?}"), Self::PackedVector2Array(v) => write !(f, "{v:?}"), Self::PackedVector3Array(v) => write !(f, "{v:?}"), Self::PackedColorArray(v) => write !(f, "{v:?}"), Self::PackedVector4Array(v) => write !(f, "{v:?}"),
        }
    }
}
